...
export const renderInteractiveUIRoutingSystemPrompt = (extensions) => {
  const lines = [
    ...
    'Selection order: (1) an explicitly named tool, (2) a matching installed business tool, (3) another matching specialized or MCP tool, (4) interactive_ui for ad-hoc visualization using standard components, including Host-owned tabs or accordion, (5) html_artifact when explicitly requested or when custom SVG, animation, playback, sliders, drag, a simulator, or other local interaction cannot reasonably be expressed by standard components, (6) a normal text answer.',
