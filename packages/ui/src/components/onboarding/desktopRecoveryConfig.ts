  ...
  switch (variant) {
    ...
    case 'remote-wrong-service': {
      ...
      return {
        ...
        description: `The server at "${host || 'unknown'}" is not running OpenLoop. Verify the address points to an OpenLoop server.`,
    ...
    case 'remote-incompatible': {
      ...
      return {
        ...
        description: `The OpenLoop server at "${host || 'unknown'}" is not compatible with this app version. Update OpenLoop on the server, then try again.`,
