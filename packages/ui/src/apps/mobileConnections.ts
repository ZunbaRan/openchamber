  ...
  const redeemPairingConnection = React.useCallback(async (payload: PairingConnectionPayload) => {
    ...
    try {
      ...
      const redeemBody = JSON.stringify({
        ...
        clientLabel: 'OpenLoop Mobile',
        clientKind: 'mobile',
        deviceName: 'OpenLoop Mobile',
  ...
  const submitPassword = React.useCallback(async (password: string) => {
    ...
    try {
      ...
      const loginInit = {
        ...
        body: JSON.stringify({ password, trustDevice: true, issueClientToken: true, clientLabel: 'OpenLoop Mobile', clientKind: 'mobile', devicePlatform: mobileDevicePlatform(), dedupeKey: mobileClientDedupeKey() }),
      };
