...
export const dict: Record<I18nKey, string> = {
  ...
  'interactiveUI.state.unreachable.description': 'OpenChamber nie mógł połączyć się ze skonfigurowaną usługą. Zapisane dane pozostaną bez zmian.',
  ...
  'interactiveUI.artifact.unsupportedRuntime': 'HTML Artifact nie jest obsługiwany w tym środowisku.',
  'interactiveUI.artifact.navigationBlocked': 'Nawigacja Artifact została zablokowana.',
  'interactiveUI.artifact.state.unsupported.title': 'Artifact jest niedostępny w tym środowisku',
  'interactiveUI.artifact.state.unsupported.description': 'To środowisko OpenChamber nie obsługuje Artifactów HTML. Oryginalny wynik Tool pozostaje dostępny.',
  ...
  'interactiveUI.artifact.state.timed-out.description': 'OpenChamber zatrzymał ramkę, ponieważ ustał sygnał aktywności lub upłynął maksymalny czas wykonania. Uruchom ponownie, aby spróbować jeszcze raz.',
  ...
  'interactiveUI.artifact.state.error.description': 'OpenChamber nie mógł przygotować tej strony. Oryginalny wynik Tool pozostaje dostępny.',
  ...
  'shell.outputs.label': 'Wyniki',
  'shell.outputs.empty': 'Dla tego zadania nie zarejestrowano jeszcze nowych plików ani załączników.',
  ...
  'layout.rightSidebar.extensions': 'Tablica aplikacji',
  'shell.rightRail.aria': 'Prawy panel boczny',
  'shell.brand.menu': 'Otwórz menu OpenChamber',
  'shell.navigation.primaryAria': 'Nawigacja główna',
  'shell.navigation.newTask': 'Nowe zadanie',
  'shell.navigation.newTaskMenu': 'Więcej opcji nowego zadania',
  'shell.navigation.projects': 'Projekty',
  'shell.navigation.git': 'Git',
  'shell.navigation.scheduled': 'Zaplanowane',
  'shell.navigation.applications': 'Aplikacje',
  'shell.navigation.plugins': 'Wtyczki',
  'shell.navigation.tasks': 'Zadania',
  'shell.navigation.tasksMenu': 'Opcje listy zadań',
  'shell.navigation.advanced': 'Zaawansowane',
  'shell.navigation.compareModels': 'Porównaj modele',
  'shell.resources.add': 'Dodaj zasób',
  'shell.resources.addAria': 'Otwórz menu zasobów',
  'shell.resources.sideTask': 'Zadanie boczne',
  'shell.resources.browser': 'Przeglądarka',
  ...
  'workbench.tile.descriptionFallback': 'Ta powierzchnia jest gotowa do wczytania w pulpicie rozszerzeń.',
  ...
  'workbench.tile.context': 'Kontekst',
