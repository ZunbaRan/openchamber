...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': 'Zainstaluj OpenLoop, aby mieć szybszy dostęp',
  'pwa.installPrompt.action': 'Zainstaluj',
  'pwa.installPrompt.dismiss': 'Odrzuć',
  'pwa.installPrompt.started': 'Instalacja rozpoczęta',
  'pwa.installPrompt.installed': 'OpenLoop został zainstalowany',
  ...
  'mobile.connect.welcome.title': 'Połącz z OpenLoop',
  ...
  'mobile.connect.password.placeholder': 'Hasło OpenLoop',
  ...
  'mobile.connect.scan.invalid': 'Ten kod QR nie jest kodem połączenia OpenLoop.',
  ...
  'mobile.connect.relay.badge': 'przez OpenLoop Relay',
  ...
  'mobile.connect.error.unreachable': 'Nie udało się połączyć z tym serwerem OpenLoop.',
  ...
  'sessions.sidebar.footer.actions.aboutOpenLoop': 'O OpenLoop',
  ...
  'multiRun.window.description': 'Okno wielokrotnego uruchomienia OpenLoop.',
  ...
  'onboarding.chooser.title': 'Witaj w OpenLoop',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli OpenLoop nie wykryje OpenCode automatycznie, ustaw ścieżkę binarki poniżej.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień OpenLoop i przeładowuje konfigurację OpenCode.',
  ...
  'onboarding.remoteConnection.description': 'Wpisz adres serwera OpenLoop aby się połączyć.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestie: Zweryfikuj czy URL wskazuje na serwer OpenLoop, lub skontaktuj się z administratorem serwera.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Ta instancja używa innej wersji OpenLoop. Możesz się połączyć, ale zaktualizuj obie aplikacje, jeśli coś nie działa.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Serwer uruchamia OpenLoop, ale nie jest zgodny z tą wersją aplikacji. Zaktualizuj OpenLoop na serwerze i spróbuj ponownie.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Serwer odpowiedział, ale nie uruchomiono na nim OpenLoop. Zweryfikuj czy adres wskazuje na serwer OpenLoop.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Serwer pod adresem "{host}" nie uruchamia OpenLoop. Zweryfikuj czy adres wskazuje na serwer OpenLoop.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Wymagana aktualizacja serwera',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Serwer OpenLoop pod adresem "{host}" nie jest zgodny z tą wersją aplikacji. Zaktualizuj OpenLoop na serwerze i spróbuj ponownie.',
  ...
  'startup.initRecovery.description': 'OpenLoop nie mógł dokończyć inicjalizacji. Sprawdź czy serwer działa, następnie spróbuj ponownie.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan OpenLoop, kondycję OpenCode, katalogi i projekty.',
  ...
  'aboutDialog.openChamberVersionLabel': 'Wersja OpenLoop {version}',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'Serwer OpenLoop, z którym połączona jest ta aplikacja, nie odpowiedział na API walkthroughu — jest więc starszy niż aplikacja. Zaktualizuj serwer do wersji 1.18 lub nowszej i odśwież.',
  ...
  'contextPanel.browser.trustNotice': 'Strony otwierane tutaj działają z pełnym dostępem do OpenLoop — jest to wymagane do inspekcji i zrzutów ekranu. Otwieraj tylko zaufane witryny: złośliwa strona może odczytać Twoje dane lub działać w Twoim imieniu.',
  ...
  'desktopHostSwitcher.description': 'Przełączaj między lokalnymi i zdalnymi serwerami OpenLoop',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'OpenLoop potrzebuje dostępu do tego folderu.',
  ...
  'filesView.editor.binaryFileDescription': 'Ten plik jest binarny i nie można go edytować w OpenLoop. Pobierz go, aby otworzyć w innej aplikacji.',
  ...
  'header.actions.openAppMenu': 'Menu OpenLoop',
  'header.actions.openAppMenuAria': 'Otwórz menu OpenLoop',
  ...
  'helpDialog.description': 'Użyj tych skrótów klawiaturowych, aby sprawnie poruszać się po OpenLoop.',
  ...
  'sessionAuth.error.networkDescription': 'Nie udało się zweryfikować sesji UI. Jeśli otwierasz OpenLoop z innego urządzenia w sieci lokalnej, włącz Desktop Network Access w aplikacji desktopowej i użyj adresu LAN widocznego w Ustawieniach.',
  ...
  'sessionAuth.locked.unlockTitle': 'Odblokuj OpenLoop',
  ...
  'mobileUpdate.toast.available.title': 'Dostępna aktualizacja OpenLoop',
  ...
  'updateDialog.header.updating': 'Aktualizowanie OpenLoop...',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Pozostaw OpenLoop otwarte.',
  ...
  'onboarding.localSetup.intro': 'OpenCode to serce OpenLoop — zainstaluj je, aby zacząć.',
  ...
  'chat.messageBody.richResult.showAgentNotes': 'Pokaż notatki agenta',
  'interactiveUI.artifact.exitExpanded': 'Wróć do rozmowy',
  'interactiveUI.artifact.experimental': 'Eksperymentalne',
  'interactiveUI.artifact.followUpPrepared': 'Dalsze pytanie dodano do pola wiadomości do sprawdzenia.',
  'interactiveUI.artifact.fullscreen': 'Otwórz na pełnym ekranie',
  'interactiveUI.artifact.interactive': 'Interaktywny Artifact',
  'interactiveUI.artifact.originalToolOutput': 'Oryginalne wyjście Tool',
  'interactiveUI.artifact.poppedOut': 'Ten Artifact jest otwarty w osobnym oknie. Zamknij je, aby przywrócić go tutaj.',
  'interactiveUI.artifact.retry': 'Ponów',
  'interactiveUI.artifact.state.blocked.description': 'Wygenerowana strona zażądała znaczników, nawigacji lub możliwości wykonywania spoza kontraktu bezpieczeństwa Artifact.',
  'interactiveUI.artifact.state.blocked.title': 'Artifact zablokowany ze względów bezpieczeństwa',
  'interactiveUI.artifact.state.corrupt.description': 'Zapisany dokument jest brakujący lub uszkodzony. Spróbuj ponownie, aby odbudować go z oryginalnego wyniku rozmowy.',
  'interactiveUI.artifact.state.corrupt.title': 'Pamięć podręczna Artifact wymaga odbudowy',
  'interactiveUI.artifact.state.crashed.description': 'Strona zgłosiła błąd wykonania i została usunięta z widoku. Nie otrzymała uprawnień hosta ani systemu biznesowego.',
  'interactiveUI.artifact.state.crashed.title': 'Artifact zatrzymany po błędzie',
  'interactiveUI.artifact.state.error.description': 'OpenLoop nie mógł przygotować tej strony. Oryginalny wynik Tool pozostaje dostępny.',
  'interactiveUI.artifact.state.error.title': 'Nie udało się załadować Artifact',
  'interactiveUI.artifact.state.scripts-disabled.description': 'To środowisko zezwala tylko na statyczne Artifacty. Oryginalny wynik Tool pozostaje dostępny.',
  'interactiveUI.artifact.state.scripts-disabled.title': 'Interaktywne Artifacty są wyłączone',
  'interactiveUI.artifact.state.stopped.description': 'Zatrzymano wykonywanie. Uruchom ponownie, aby utworzyć nową izolowaną ramkę.',
  'interactiveUI.artifact.state.stopped.title': 'Artifact zatrzymany',
  'interactiveUI.artifact.state.timed-out.description': 'OpenLoop zatrzymał ramkę, ponieważ ustał sygnał aktywności lub upłynął maksymalny czas wykonania. Uruchom ponownie, aby spróbować jeszcze raz.',
  'interactiveUI.artifact.state.timed-out.title': 'Dzierżawa wykonania Artifact wygasła',
  'interactiveUI.artifact.state.unsupported.description': 'To środowisko OpenLoop nie obsługuje Artifactów HTML. Oryginalny wynik Tool pozostaje dostępny.',
  'interactiveUI.artifact.state.unsupported.title': 'Artifact jest niedostępny w tym środowisku',
  'interactiveUI.artifact.static': 'Statyczny Artifact',
  'interactiveUI.artifact.stop': 'Zatrzymaj Artifact',
  'interactiveUI.artifact.workspace': 'Otwórz w obszarze roboczym',
  'interactiveUI.code.copied': 'Kod skopiowano',
  'interactiveUI.code.copy': 'Kopiuj kod',
  'interactiveUI.common.horizontalScrollHint': 'Przewiń poziomo, aby zobaczyć więcej',
  'interactiveUI.common.nextPage': 'Następna strona',
  'interactiveUI.common.noData': 'Brak danych.',
  'interactiveUI.common.previousPage': 'Poprzednia strona',
  'interactiveUI.common.search': 'Szukaj',
  'interactiveUI.host.live': 'Dane na żywo',
  'interactiveUI.host.snapshot': 'Migawka',
  'interactiveUI.state.error.description': 'Nie udało się wczytać widoku. Oryginalny wynik narzędzia jest nadal dostępny.',
  'interactiveUI.state.error.title': 'Interactive UI jest niedostępny',
  'interactiveUI.state.forbidden.description': 'Połączony klucz nie zezwala na tę operację.',
  'interactiveUI.state.forbidden.title': 'Odmowa dostępu',
  'interactiveUI.state.retry': 'Spróbuj ponownie',
  'interactiveUI.state.stale.description': 'Ostatnie odświeżenie nie powiodło się. Widok zachowuje ostatni poprawny wynik.',
  'interactiveUI.state.stale.title': 'Wyświetlanie zapisanych danych',
  'interactiveUI.state.unauthorized.description': 'Zastąp lub odnów klucz dostępu i spróbuj ponownie.',
  'interactiveUI.state.unauthorized.title': 'Połączenie wygasło',
  'interactiveUI.state.unconfigured.description': 'Skonfiguruj połączenie biznesowe tego rozszerzenia i spróbuj ponownie.',
  'interactiveUI.state.unconfigured.title': 'Wymagana konfiguracja połączenia',
  'interactiveUI.state.unreachable.description': 'OpenLoop nie mógł połączyć się ze skonfigurowaną usługą. Zapisane dane pozostaną bez zmian.',
  'interactiveUI.state.unreachable.title': 'System biznesowy jest niedostępny',
  'shell.navigation.applications': 'Aplikacje',
  'shell.resources.add': 'Dodaj zasób',
  'shell.resources.addAria': 'Otwórz menu zasobów',
  'workbench.board.emptyDescription': 'Wybierz dostępną powierzchnię z katalogu lub przypnij ją z rozmowy.',
  'workbench.board.emptyTitle': 'Zbuduj tablicę projektu',
  'workbench.board.subtitle': '{count} kafelków na tablicy tego projektu',
  'workbench.board.title': 'Pulpit rozszerzeń',
  'workbench.catalog.aria': 'Katalog rozszerzeń',
  'workbench.catalog.collapse': 'Zwiń katalog rozszerzeń',
  'workbench.catalog.empty': 'Żadne zainstalowane rozszerzenie nie udostępnia powierzchni pulpitu.',
  'workbench.catalog.expand': 'Rozwiń katalog rozszerzeń',
  "workbench.catalog.lifecycleBlocked": "Zablokowano: ta aplikacja ma oczekującą wymaganą aktualizację lub nieprawidłowe zaufanie. Rozwiąż problem przed uruchamianiem powierzchni.",
  "workbench.catalog.lifecycleBlockedReason": "Zablokowano przez wymaganą aktualizację lub problem z zaufaniem",
  "workbench.catalog.lifecycleUnreachable": "Ta aplikacja jest teraz nieosiągalna. Buforowana podpisana zawartość może nadal być wyświetlana.",
  'workbench.catalog.requiresContext': 'Wymaga parametrów kontekstu',
  'workbench.catalog.title': 'Rozszerzenia',
  'workbench.loading': 'Ładowanie pulpitu rozszerzeń…',
  'workbench.noProject': 'Otwórz projekt, aby użyć pulpitu rozszerzeń.',
  'workbench.pin.added': 'Przypięto do pulpitu rozszerzeń',
  'workbench.pin.aria': 'Przypnij do pulpitu rozszerzeń',
  'workbench.pin.failed': 'Nie udało się przypiąć powierzchni',
  'workbench.pin.focused': 'Powiększono istniejący kafelek pulpitu',
  'workbench.pin.installedSurfaceMissing': 'Powierzchnia zainstalowanego rozszerzenia nie jest już dostępna.',
  'workbench.pin.label': 'Przypnij',
  'workbench.pin.noProject': 'Otwórz projekt przed przypięciem tej powierzchni.',
  'workbench.refresh': 'Odśwież',
  'workbench.tile.exitFocus': 'Wyjdź z powiększenia',
  'workbench.tile.focus': 'Powiększ kafelek',
  'workbench.tile.generated': 'Powierzchnia wygenerowana przez Agent',
  'workbench.tile.generatedSnapshotUnavailable': 'Ta wygenerowana migawka nie jest już dostępna. Przypnij ją ponownie z rozmowy.',
  'workbench.tile.more': 'Więcej działań kafelka',
  'workbench.tile.popout': 'Otwórz kafelek w osobnym oknie',
  'workbench.tile.popoutUnavailable': 'W bieżącym środowisku tej powierzchni nie można przenieść do okna systemowego.',
  'workbench.tile.poppedOut': 'Ten kafelek jest otwarty w osobnym oknie. Zamknij je, aby przywrócić go tutaj.',
  'workbench.tile.remove': 'Usuń z tablicy',
  'workbench.tile.resize': 'Zmień rozmiar kafelka',
  'workbench.tile.restorePopout': 'Przywróć kafelek do tablicy',
  'workbench.tile.surfaceUnavailable': 'Ta powierzchnia rozszerzenia jest wyłączona, brakująca lub niezgodna.',
