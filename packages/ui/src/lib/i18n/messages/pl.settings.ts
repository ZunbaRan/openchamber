export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Skopiuj ID z adresu panelu i cookie auth z narzędzi deweloperskich przeglądarki. OpenLoop nigdy nie skanuje plików cookie przeglądarki.',
  ...
  'settings.github.page.flow.title': 'Autoryzuj OpenLoop',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Dostępne jako rezerwa, jeśli uwierzytelnienie OpenLoop zostanie usunięte',
  ...
  'settings.notifications.page.testNotification.body': 'To jest powiadomienie testowe z OpenLoop.',
  ...
  'settings.openchamber.about.title': 'O OpenLoop',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLogin': 'Uruchamiaj OpenLoop przy logowaniu',
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': 'Uruchamiaj OpenLoop przy logowaniu',
  ...
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': 'Pokazuj OpenLoop na pasku menu macOS',
  'settings.openchamber.desktopNetwork.field.macMenuBar': 'Pokazuj OpenLoop na pasku menu',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': 'Wymaga ponownego uruchomienia aplikacji. Po wyłączeniu OpenLoop nie tworzy elementu paska menu ani nie uruchamia aktualizacji sesji, zatwierdzeń i użycia.',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': 'Minimalizuj i zamykaj OpenLoop do zasobnika systemowego',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': 'Minimalizuj i zamykaj do zasobnika systemowego',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': 'Utrzymuje OpenLoop w zasobniku systemowym, gdy główne okno jest zminimalizowane lub zamknięte.',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'Utrzymuj komputer aktywny, gdy OpenLoop jest uruchomiony',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'Utrzymuj komputer aktywny, gdy OpenLoop jest uruchomiony',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'OpenLoop pyta po restarcie, a potem po wygaśnięciu sesji logowania: po 12 godzinach albo po 7 dniach z opcją Zaufaj temu urządzeniu. Zostaw puste, aby wyłączyć logowanie.',
  ...
  'settings.openchamber.visual.field.dockIcon': 'Ikona Docka',
  'settings.openchamber.visual.field.dockIconHint': 'Wybierz ikonę wyświetlaną w Docku macOS, gdy OpenLoop jest uruchomiony. Finder i Launchpad zachowują ikonę zainstalowanej aplikacji.',
  'settings.openchamber.visual.field.dockIconAria': 'Styl ikony Docka',
  'settings.openchamber.visual.option.dockIcon.ice': 'Lodowy błękit',
  'settings.openchamber.visual.option.dockIcon.black': 'Czarny',
  ...
  'settings.page.appearance.description': 'Dostosuj wygląd i odczucie OpenLoop.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Klucze są wysyłane bezpośrednio do OpenCode i nigdy nie są przechowywane przez OpenLoop.',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Przechowywany w auth OpenCode, nie przez OpenLoop. Użyj {env:VAR_NAME}, aby odczytać klucz ze zmiennej środowiskowej.',
  ...
  'settings.remoteInstances.page.description': 'Połącz się z inną maszyną przez SSH i otwórz tam OpenLoop.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'Jak OpenLoop ma zostać umieszczony na zdalnej maszynie, gdy aplikacja uruchamia go za Ciebie.',
  ...
  'settings.remoteInstances.page.field.keepServerRunningHint': 'Pozostaw OpenLoop uruchomiony na zdalnej maszynie po rozłączeniu.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Wybierz, czy OpenLoop ma uruchomić serwer za Ciebie, czy połączyć się z już działającym.',
  ...
  'settings.remoteInstances.page.phase.installingOpenLoop': 'Instalowanie OpenLoop',
  ...
  'settings.remoteInstances.page.phase.updatingOpenLoop': 'Aktualizowanie OpenLoop',
  ...
  'settings.remoteInstances.page.section.authenticationDescription': 'Opcjonalne dane logowania dla SSH i zdalnego interfejsu OpenLoop.',
  ...
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Wybierz lokalny adres używany do otwierania tego zdalnego serwera OpenLoop.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'OpenLoop na zdalnej maszynie',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Wybierz, jak OpenLoop ma działać po połączeniu SSH.',
  ...
  'settings.remoteInstances.direct.title': 'Inne serwery OpenLoop',
  ...
  'settings.remoteInstances.direct.addDialog.description': 'Dodaj inny serwer OpenLoop przez URL. Użyj tego, gdy serwer już działa i masz token połączenia.',
  ...
  'settings.remoteInstances.direct.import.description': 'Wklej link połączenia z innego serwera OpenLoop.',
  ...
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Nieprawidłowy link połączenia OpenLoop.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Utwórz bezpieczny link lub token, aby OpenLoop Desktop mógł połączyć się z tym serwerem.',
  ...
  'settings.remoteInstances.clientAuth.qrAlt': 'Kod QR połączenia OpenLoop',
  'settings.remoteInstances.clientAuth.qrEnlarge': 'Powiększ kod QR',
  'settings.remoteInstances.clientAuth.qrScanHint': 'Zeskanuj to aplikacją OpenLoop na drugim urządzeniu. Jednorazowy i wygasa.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': 'Działa w domu i poza nim. Poza domem ruch przechodzi przez OpenLoop Private Relay — szyfrowany end-to-end tunel. Bez konfiguracji.',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': 'Zeskanuj ten kod QR aplikacją OpenLoop na drugim urządzeniu.',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Dodaj repozytorium Git jako nowe źródło katalogu. OpenLoop przeskanuje je w poszukiwaniu folderów zawierających',
  ...
  'settings.voice.page.tooltip.sttLocal': 'Transkrypcja lokalna na serwerze OpenLoop. Modele pobierają się automatycznie; klucz API nie jest potrzebny.',
  'settings.voice.page.tooltip.localTts': 'Lokalna synteza na serwerze OpenLoop (Kokoro, angielski). Model pobiera się automatycznie; klucz API nie jest potrzebny.',
  ...
  'settings.window.description': 'Okno ustawień OpenLoop.',
  ...
  'settings.interactiveUI.actions.addMarketplace': 'Dodaj rynek',
  'settings.interactiveUI.actions.approveHostedUpdate': 'Zatwierdź i zaktualizuj',
  'settings.interactiveUI.actions.browseCatalog': 'Przeglądaj katalog',
  'settings.interactiveUI.actions.cancel': 'Anuluj',
  'settings.interactiveUI.actions.checkHealthUpdates': 'Sprawdź stan i aktualizacje',
  'settings.interactiveUI.actions.connect': 'Połącz',
  'settings.interactiveUI.actions.disconnect': 'Rozłącz',
  'settings.interactiveUI.actions.enableAria': 'Włącz {name}',
  'settings.interactiveUI.actions.install': 'Zainstaluj',
  'settings.interactiveUI.actions.installPackage': 'Zainstaluj .ocix',
  'settings.interactiveUI.actions.installed': 'Zainstalowano',
  'settings.interactiveUI.actions.refresh': 'Odśwież',
  'settings.interactiveUI.actions.refreshHosted': 'Odśwież aplikację hostowaną',
  'settings.interactiveUI.actions.remove': 'Usuń',
  'settings.interactiveUI.actions.reviewRemote': "Przejrzyj aplikację",
  'settings.interactiveUI.actions.rollback': 'Przywróć wersję',
  'settings.interactiveUI.actions.saveAndTestConnection': 'Zapisz i przetestuj',
  'settings.interactiveUI.actions.testConnection': 'Sprawdź połączenie',
  'settings.interactiveUI.actions.trustAndInstall': 'Zaufaj i zainstaluj',
  'settings.interactiveUI.actions.trustMarketplace': 'Zaufaj rynkowi',
  'settings.interactiveUI.actions.uninstall': 'Odinstaluj',
  'settings.interactiveUI.actions.update': 'Aktualizuj',
  'settings.interactiveUI.actions.useDefaultEndpoint': 'Użyj domyślnego',
  'settings.interactiveUI.connections.accessKeyInfo': 'Utwórz w systemie zewnętrznym klucz z uprawnieniami wymaganymi dla tego połączenia. Wartość jest przechowywana wyłącznie przez serwer OpenLoop.',
  'settings.interactiveUI.connections.description': 'System zewnętrzny określa uprawnienia każdego klucza. OpenLoop przechowuje klucze na serwerze i nigdy nie udostępnia ich interfejsowi rozszerzenia ani wynikom agenta.',
  'settings.interactiveUI.connections.empty': 'Żadne zainstalowane rozszerzenie nie deklaruje połączenia biznesowego.',
  'settings.interactiveUI.connections.endpointInfo': 'Ustaw punkt końcowy interfejsu biznesowego API dla tego urządzenia. Wartość użytkownika zastępuje środowisko i manifest do czasu jej usunięcia.',
  'settings.interactiveUI.connections.endpointMissing': 'Punkt końcowy nie jest skonfigurowany',
  'settings.interactiveUI.connections.headersInfo': 'Opcjonalne nagłówki HTTP jako obiekt JSON. Nagłówki poświadczeń i niebezpieczne nagłówki transportowe są odrzucane.',
  'settings.interactiveUI.connections.lastChecked': 'sprawdzono',
  'settings.interactiveUI.connections.setupCodeInfo': 'Wprowadź jednorazowy kod wydany przez system zewnętrzny. OpenLoop wymieni go na serwerze i nigdy nie zwróci uzyskanego klucza do przeglądarki.',
  'settings.interactiveUI.connections.statusConfigured': 'Dane skonfigurowane · nietestowane',
  'settings.interactiveUI.connections.statusExpired': 'Dane uwierzytelniające wygasły',
  'settings.interactiveUI.connections.statusForbidden': 'Połączono · brak uprawnień',
  'settings.interactiveUI.connections.statusNotConnected': 'Brak połączenia',
  'settings.interactiveUI.connections.statusReachable': 'Osiągalny',
  'settings.interactiveUI.connections.statusUnauthorized': 'Dane odrzucone',
  'settings.interactiveUI.connections.statusUnreachable': 'Nieosiągalny',
  'settings.interactiveUI.connections.title': 'Połączenia biznesowe',
  'settings.interactiveUI.errors.invalidHeaders': 'Nagłówki muszą być obiektem JSON z wartościami tekstowymi.',
  'settings.interactiveUI.errors.invalidInspection': 'Wynik kontroli podpisanego pakietu jest nieprawidłowy.',
  'settings.interactiveUI.errors.invalidRemoteInspection': "Odpowiedź przeglądu aplikacji zdalnej jest nieprawidłowa.",
  'settings.interactiveUI.fields.accessKey': 'Klucz dostępu',
  'settings.interactiveUI.fields.accessKeyPlaceholder': 'Wklej klucz dostępu',
  'settings.interactiveUI.fields.appEntryUrl': "URL aplikacji",
  'settings.interactiveUI.fields.appEntryUrlPlaceholder': "https://apps.example.com/manifest.json",
  'settings.interactiveUI.fields.catalogUrl': 'URL podpisanego katalogu',
  'settings.interactiveUI.fields.endpoint': 'Punkt końcowy API',
  'settings.interactiveUI.fields.endpointPlaceholder': 'https://business.example.com/api/',
  'settings.interactiveUI.fields.headers': 'Opcjonalne nagłówki',
  'settings.interactiveUI.fields.headersConfiguredPlaceholder': 'Skonfigurowano {count} nagłówków; wpisz JSON, aby je zastąpić',
  'settings.interactiveUI.fields.headersPlaceholder': '{"X-Tenant-ID":"acme"}',
  'settings.interactiveUI.fields.replaceAccessKeyPlaceholder': 'Wprowadź klucz zastępczy',
  'settings.interactiveUI.fields.setupCode': 'Jednorazowy kod konfiguracji',
  'settings.interactiveUI.fields.setupCodePlaceholder': 'Wprowadź kod konfiguracji',
  'settings.interactiveUI.hostedUpdate.description': '{name} {version} żąda nowych możliwości. Poprzednia zweryfikowana wersja pozostanie aktywna do czasu zatwierdzenia.',
  'settings.interactiveUI.hostedUpdate.title': 'Zatwierdzić nowe uprawnienia hostowane?',
  'settings.interactiveUI.installed.agentRuntime': 'Agent Runtime: {tools} narzędzi · {skills} umiejętności',
  'settings.interactiveUI.installed.deliveryHosted': "OCIX hostowany",
  'settings.interactiveUI.installed.deliveryLocal': "OCIX lokalny",
  'settings.interactiveUI.installed.deliveryRemote': "OCIX zdalny",
  'settings.interactiveUI.installed.description': 'W rozmowach ładowane są tylko włączone wersje ze zweryfikowanym podpisem.',
  'settings.interactiveUI.installed.diagnostics': 'Diagnostyka rozszerzenia',
  'settings.interactiveUI.installed.empty': 'Brak zainstalowanych zarządzanych rozszerzeń.',
  'settings.interactiveUI.installed.integrityFailed': 'Zablokowano: zainstalowane pliki nie przeszły weryfikacji integralności. Zainstaluj pakiet ponownie lub go odinstaluj.',
  'settings.interactiveUI.installed.integrityUnavailable': 'Zablokowano: ta starsza instalacja nie ma podpisanego rekordu integralności. Zainstaluj pakiet ponownie lub go odinstaluj.',
  'settings.interactiveUI.installed.publisher': 'Wydawca: {publisher}',
  'settings.interactiveUI.installed.remoteVersion': "zdalna {version}",
  'settings.interactiveUI.installed.skills': 'Umiejętności',
  'settings.interactiveUI.installed.source': 'Źródło instalacji',
  'settings.interactiveUI.installed.title': 'Zainstalowane rozszerzenia',
  'settings.interactiveUI.installed.tools': 'Narzędzia',
  'settings.interactiveUI.installed.unresolved': 'Nierozwiązane narzędzia',
  'settings.interactiveUI.marketplaceReview.description': 'Podpis katalogu jest prawidłowy. Przed kontynuacją sprawdź odcisk zaufanym kanałem.',
  'settings.interactiveUI.marketplaceReview.extensionCount': 'Ten katalog zawiera {count} wersji rozszerzeń.',
  'settings.interactiveUI.marketplaceReview.title': 'Zaufać temu rynkowi?',
  'settings.interactiveUI.marketplaces.catalogHint': 'Podpisany katalog zawiera tożsamość i klucz publiczny rynku. Przed zaufaniem sprawdzisz odcisk.',
  'settings.interactiveUI.marketplaces.description': 'Katalogi i skróty pakietów są weryfikowane przed instalacją kodu.',
  'settings.interactiveUI.marketplaces.title': 'Rynki rozszerzeń',
  'settings.interactiveUI.packageReview.agentRouting': 'Routing agenta: domena {domain} · źródło danych {authority} · intencje: {intents}',
  'settings.interactiveUI.packageReview.agentRuntime': 'Narzędzia Agenta: {tools} · Umiejętności: {skills}',
  'settings.interactiveUI.packageReview.nativeNo': 'nie',
  'settings.interactiveUI.packageReview.nativeYes': 'tak',
  'settings.interactiveUI.packageReview.permissions': 'Dostęp do sieci: {network} · Kod natywny: {native} · HTML w piaskownicy: {artifacts}',
  'settings.interactiveUI.packageReview.publisher': 'Wydawca i odcisk podpisu',
  'settings.interactiveUI.packageReview.surfaces': 'Powierzchnie: {interactive} Interactive UI · {artifacts} HTML Artifact',
  'settings.interactiveUI.packageReview.title': 'Sprawdź pakiet OCIX',
  'settings.interactiveUI.packageReview.trustedDescription': 'Podpis jest prawidłowy, a wydawca jest już zaufany. Sprawdź instalowane możliwości.',
  'settings.interactiveUI.packageReview.untrustedDescription': 'Podpis jest prawidłowy, ale wydawca nie jest jeszcze zaufany. Potwierdź odcisk i możliwości.',
  'settings.interactiveUI.permissionGroups.actionIds': 'Identyfikatory akcji',
  'settings.interactiveUI.permissionGroups.agentToolNames': 'Nazwy narzędzi agenta',
  'settings.interactiveUI.permissionGroups.clipboard': 'Schowek',
  'settings.interactiveUI.permissionGroups.credentialScopes': 'Zakresy poświadczeń',
  'settings.interactiveUI.permissionGroups.externalLinkOrigins': 'Źródła linków zewnętrznych',
  'settings.interactiveUI.permissionGroups.nativeCode': 'Kod natywny',
  'settings.interactiveUI.permissionGroups.networkOrigins': 'Źródła sieciowe',
  'settings.interactiveUI.permissionGroups.popups': 'Okna wyskakujące',
  'settings.interactiveUI.permissionGroups.resourceOrigins': 'Źródła zasobów',
  'settings.interactiveUI.publishers.description': 'Zaufane klucze podpisu są dodawane ze sprawdzonych pakietów OCIX i rynków. Potwierdź odciski niezależnym kanałem.',
  'settings.interactiveUI.publishers.empty': 'Wydawcy są dodawani automatycznie po sprawdzeniu pakietu OCIX lub rynku.',
  'settings.interactiveUI.publishers.title': 'Zaufani wydawcy',
  'settings.interactiveUI.remote.accessKeyInfo': "Klucz jest wysyłany tylko do tego serwera, przechowywany po stronie serwera i nigdy nie jest ujawniany w interfejsie aplikacji ani w danych wyjściowych Agenta. Autoryzuje dostęp biznesowy — nie weryfikuje zawartości aplikacji.",
  'settings.interactiveUI.remote.blockedRequired': 'Zablokowano: oczekuje wymagana aktualizacja. Przejrzyj i zastosuj ją, zanim użyjesz tej aplikacji.',
  'settings.interactiveUI.remote.description': "Połącz podpisaną aplikację zdalną za pomocą adresu URL i klucza dostępu — bez instalowania pakietu.",
  'settings.interactiveUI.remote.empty': "Nie połączono jeszcze żadnej aplikacji zdalnej.",
  'settings.interactiveUI.remote.healthReachable': 'Osiągalny',
  'settings.interactiveUI.remote.healthTrustInvalid': 'Zaufanie do wydawcy nieprawidłowe',
  'settings.interactiveUI.remote.healthUnknown': 'Nieznany stan',
  'settings.interactiveUI.remote.healthUnreachable': 'Nieosiągalny',
  'settings.interactiveUI.remote.title': "Aplikacje zdalne",
  'settings.interactiveUI.remote.updateAvailable': 'dostępna aktualizacja',
  'settings.interactiveUI.remote.updateNone': 'brak aktualizacji',
  'settings.interactiveUI.remote.updateRequired': 'oczekuje wymagana aktualizacja',
  'settings.interactiveUI.remote.urlInfo': "Podpisany adres URL manifestu Hosted OCIX. OpenLoop weryfikuje podpis kluczem wydawcy osadzonym w manifeście i wyprowadza odcisk palca lokalnie.",
  'settings.interactiveUI.remoteReview.actionIds': "Akcje biznesowe",
  'settings.interactiveUI.remoteReview.agentToolNames': "Narzędzia Agenta",
  'settings.interactiveUI.remoteReview.clipboard': "Dostęp do schowka",
  'settings.interactiveUI.remoteReview.connector': "Łącznik biznesowy",
  'settings.interactiveUI.remoteReview.copied': "Skopiowano",
  'settings.interactiveUI.remoteReview.copyFailed': "Nie udało się skopiować odcisku palca wydawcy",
  'settings.interactiveUI.remoteReview.copyFingerprint': "Kopiuj odcisk palca",
  'settings.interactiveUI.remoteReview.credentialScopes': "Zakresy poświadczeń",
  'settings.interactiveUI.remoteReview.externalLinkOrigins': "Pochodzenie linków zewnętrznych",
  'settings.interactiveUI.remoteReview.keyWarning': "Klucz dostępu autoryzuje wyłącznie dostęp do API biznesowego. To podpis chroni zawartość aplikacji.",
  'settings.interactiveUI.remoteReview.manifest': "Podpisany manifest",
  'settings.interactiveUI.remoteReview.nativeCode': "Kod natywny w oknie OpenLoop",
  'settings.interactiveUI.remoteReview.networkOrigins': "Pochodzenie sieciowe",
  'settings.interactiveUI.remoteReview.permissionsTitle': "Żądane uprawnienia",
  'settings.interactiveUI.remoteReview.popups': "Okna pop-up",
  'settings.interactiveUI.remoteReview.publisher': "Wydawca i odcisk palca podpisu",
  'settings.interactiveUI.remoteReview.resourceOrigins': "Pochodzenie zasobów",
  'settings.interactiveUI.remoteReview.title': "Przejrzyj aplikację zdalną",
  'settings.interactiveUI.remoteReview.trustedDescription': "Podpis jest prawidłowy, a ten wydawca jest już zaufany. Przejrzyj aplikację i jej uprawnienia przed połączeniem.",
  'settings.interactiveUI.remoteReview.untrustedDescription': "Podpis jest prawidłowy, ale ten wydawca nie jest jeszcze zaufany. Potwierdź odcisk palca i uprawnienia przed połączeniem.",
  'settings.interactiveUI.remoteUpdate.addedPermissions': 'Żądane nowe uprawnienia',
  'settings.interactiveUI.remoteUpdate.app': 'Aplikacja',
  'settings.interactiveUI.remoteUpdate.changeSummary': 'Co się zmieniło',
  'settings.interactiveUI.remoteUpdate.confirm': 'Potwierdź i zaktualizuj',
  'settings.interactiveUI.remoteUpdate.description': '{name} opublikował nową podpisaną wersję. Przejrzyj zmiany przed zastosowaniem. Twoja obecna wersja pozostanie aktywna do czasu potwierdzenia.',
  'settings.interactiveUI.remoteUpdate.keyChanged': 'Wydawca podpisuje NOWYM kluczem. Przed kontynuowaniem potwierdź nowy odcisk; poprzedni klucz zostaje zachowany do weryfikacji.',
  'settings.interactiveUI.remoteUpdate.nativeCodeWarning': 'Ta aktualizacja włącza wykonywanie KODU NATYWNEGO. Powierzchnie natywne mogą uruchamiać dowolny kod na tym urządzeniu z uprawnieniami aplikacji.',
  'settings.interactiveUI.remoteUpdate.notNow': 'Nie teraz',
  'settings.interactiveUI.remoteUpdate.requiredDescription': '{name} opublikował WYMAGANĄ aktualizację. Aplikacja pozostanie zablokowana do czasu jej przejrzenia i zastosowania.',
  'settings.interactiveUI.remoteUpdate.title': 'Przejrzyj aktualizację aplikacji zdalnej',
  'settings.interactiveUI.remoteUpdate.versionChange': 'Zmiana wersji',
  'settings.interactiveUI.routingInspector.candidateSummary': 'Domena {domain} · priorytet {priority} · {operation} · połączenie {connection}',
  'settings.interactiveUI.routingInspector.candidates': 'Katalog dostępnych możliwości ({count})',
  'settings.interactiveUI.routingInspector.clear': 'Wyczyść',
  'settings.interactiveUI.routingInspector.contextSummary': 'Kontekst systemowy: {injected} · dostępne narzędzia: {count} · rewizja {revision}',
  'settings.interactiveUI.routingInspector.copied': 'Skopiowano',
  'settings.interactiveUI.routingInspector.copy': 'Kopiuj raport',
  'settings.interactiveUI.routingInspector.copyFailed': 'Nie udało się skopiować raportu routingu',
  'settings.interactiveUI.routingInspector.description': 'Ostatnie ślady routingu przechowywane wyłącznie w pamięci podczas tej sesji aplikacji. Tekst polecenia, rozumowanie modelu, punkty końcowe, dane uwierzytelniające ani odpowiedzi biznesowe nie są zachowywane.',
  'settings.interactiveUI.routingInspector.empty': 'Wyślij wiadomość, aby utworzyć ślad routingu w tej sesji aplikacji.',
  'settings.interactiveUI.routingInspector.injectedNo': 'niedostępny',
  'settings.interactiveUI.routingInspector.injectedYes': 'wstrzyknięty',
  'settings.interactiveUI.routingInspector.noCandidates': 'W chwili wysłania tej wiadomości nie było dostępnych zainstalowanych narzędzi Interactive UI.',
  'settings.interactiveUI.routingInspector.noSelection': 'Nie zaobserwowano narzędzia Interactive UI',
  'settings.interactiveUI.routingInspector.reason.businessTool': 'wybrano zainstalowane narzędzie biznesowe',
  'settings.interactiveUI.routingInspector.reason.explicitTool': 'jawnie wskazane przez użytkownika',
  'settings.interactiveUI.routingInspector.reason.genericArtifact': 'wybrano HTML Artifact dla niestandardowego interfejsu',
  'settings.interactiveUI.routingInspector.reason.genericTool': 'wybrano ogólne narzędzie wizualizacji',
  'settings.interactiveUI.routingInspector.reason.specializedTool': 'wybrano zainstalowane narzędzie specjalistyczne',
  'settings.interactiveUI.routingInspector.selectionSummary': 'Wybrano {tool} · {reason}',
  'settings.interactiveUI.routingInspector.status.artifactFailed': 'Błąd Artifact',
  'settings.interactiveUI.routingInspector.status.artifactMaterializing': 'Tworzenie Artifact',
  'settings.interactiveUI.routingInspector.status.artifactRendered': 'Artifact wyrenderowany',
  'settings.interactiveUI.routingInspector.status.awaitingTool': 'Oczekiwanie na wybór modelu',
  'settings.interactiveUI.routingInspector.status.sendFailed': 'Nie udało się wysłać wiadomości',
  'settings.interactiveUI.routingInspector.status.toolCompleted': 'Narzędzie zakończone',
  'settings.interactiveUI.routingInspector.status.toolFailed': 'Narzędzie zakończyło się błędem',
  'settings.interactiveUI.routingInspector.status.toolRunning': 'Narzędzie działa',
  'settings.interactiveUI.routingInspector.status.viewFailed': 'Renderowanie widoku nie powiodło się',
  'settings.interactiveUI.routingInspector.status.viewLoading': 'Ładowanie widoku',
  'settings.interactiveUI.routingInspector.status.viewRendered': 'Widok wyrenderowany',
  'settings.interactiveUI.routingInspector.title': 'Inspektor routingu',
  'settings.interactiveUI.routingInspector.traceIdentity': 'Sesja {session} · wiadomość {message} · {time}',
  'settings.interactiveUI.routingInspector.viewSummary': 'widok {view}',
  'settings.interactiveUI.status.loading': 'Ładowanie rozszerzeń…',
  'settings.interactiveUI.stylePreset.character.financial': 'Finansowy',
  'settings.interactiveUI.stylePreset.character.playful': 'Radosny',
  'settings.interactiveUI.stylePreset.character.professional': 'Profesjonalny',
  'settings.interactiveUI.stylePreset.description': 'Wybierz język projektowy powierzchni Interactive UI. Dotyczy wszystkich rozszerzeń i generowanych widoków.',
  ...
  'settings.interactiveUI.stylePreset.title': 'Styl Interactive UI',
  'settings.interactiveUI.stylePreset.trademark': 'Predefiniowane style są inspirowane znanymi produktami i nie są z nimi powiązane ani przez nie popierane.',
  'settings.interactiveUI.toast.actionFailed': 'Operacja rozszerzenia nie powiodła się',
  'settings.interactiveUI.toast.catalogFailed': 'Nie udało się wczytać katalogu',
  'settings.interactiveUI.toast.connectionEndpointCleared': 'Usunięto nadpisanie punktu końcowego.',
  'settings.interactiveUI.toast.connectionProvisioned': 'Nawiązano połączenie biznesowe',
  'settings.interactiveUI.toast.connectionRemoved': 'Usunięto połączenie biznesowe',
  'settings.interactiveUI.toast.connectionSaved': 'Klucz połączenia zapisano',
  'settings.interactiveUI.toast.connectionTested': 'Test połączenia zakończył się powodzeniem',
  'settings.interactiveUI.toast.disabled': 'Rozszerzenie wyłączone',
  'settings.interactiveUI.toast.enabled': 'Rozszerzenie włączone',
  'settings.interactiveUI.toast.hostedRefreshed': 'Odświeżono aplikację hostowaną',
  ...
  'settings.interactiveUI.toast.marketplaceAdded': 'Rynek dodany',
  'settings.interactiveUI.toast.marketplaceRemoved': 'Rynek usunięty',
  'settings.interactiveUI.toast.publisherRemoved': 'Klucz wydawcy usunięty',
  'settings.interactiveUI.toast.remoteConnected': "Połączono aplikację zdalną",
  'settings.interactiveUI.toast.remoteUpdateApplied': 'Zaktualizowano aplikację zdalną',
  'settings.interactiveUI.toast.remoteUpdateNone': 'Aplikacja zdalna jest aktualna',
  'settings.interactiveUI.toast.remoteUpdatePending': 'Aktualizacja zostanie zastosowana automatycznie przy następnym użyciu',
  'settings.interactiveUI.toast.remoteUpdateRequired': 'Oczekuje wymagana aktualizacja',
  'settings.interactiveUI.toast.rolledBack': 'Przywrócono poprzednią wersję',
  'settings.interactiveUI.toast.uninstalled': 'Rozszerzenie przeniesiono do pamięci odzyskiwania',
  ...
  'settings.page.interactiveUI.description': 'Instaluj i zarządzaj podpisanymi modułami firmowymi OCIX.',
  'settings.page.interactiveUI.title': 'Aplikacje',
};
