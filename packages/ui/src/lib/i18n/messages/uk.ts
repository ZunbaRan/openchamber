...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Установіть OpenLoop для швидшого доступу",
  "pwa.installPrompt.action": "Установити",
  "pwa.installPrompt.dismiss": "Сховати",
  "pwa.installPrompt.started": "Установлення розпочато",
  "pwa.installPrompt.installed": "OpenLoop встановлено",
  ...
  "mobile.connect.welcome.title": "Підключись до OpenLoop",
  ...
  "mobile.connect.password.placeholder": "Пароль OpenLoop",
  ...
  "mobile.connect.scan.invalid": "Це не QR-код підключення OpenLoop.",
  ...
  "mobile.connect.relay.badge": "через OpenLoop Relay",
  ...
  "mobile.connect.error.unreachable": "Не вдалося достукатись до цього OpenLoop сервера.",
  ...
  "sessions.sidebar.footer.actions.aboutOpenLoop": "Про OpenLoop",
  ...
  "walkthrough.blocked.serverUnsupported.description": "Сервер OpenLoop, до якого підключено застосунок, не відповів на walkthrough API — отже, він старіший за застосунок. Оновіть сервер до 1.18 або новішої версії та оновіть панель.",
  ...
  "contextPanel.browser.trustNotice": "Сторінки, відкриті тут, працюють із повним доступом до OpenLoop — це потрібно для inspect і скріншотів. Відкривайте лише сайти, яким довіряєте: шкідлива сторінка може прочитати ваші дані чи діяти від вашого імені.",
  ...
  "filesView.editor.binaryFileDescription": "Цей файл є бінарним і його не можна редагувати в OpenLoop. Завантажте його, щоб відкрити в іншій програмі.",
  ...
  "directoryExplorerDialog.browse.permissionDenied": "OpenLoop потрібен доступ до цієї папки.",
  ...
  "aboutDialog.openChamberVersionLabel": "Версія OpenLoop {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Містить стан OpenLoop, стан OpenCode, каталоги та проєкти.",
  ...
  "helpDialog.description": "Використовуйте ці комбінації клавіш для ефективної навігації OpenLoop",
  ...
  "header.actions.openAppMenu": "Меню OpenLoop",
  "header.actions.openAppMenuAria": "Відкрити меню OpenLoop",
  ...
  "sessionAuth.error.networkDescription": "Нам не вдалося перевірити сесію інтерфейсу. Якщо ви відкриваєте OpenLoop з іншого пристрою у локальній мережі, увімкніть Desktop Network Access у настільному застосунку та використайте LAN-адресу, показану в налаштуваннях.",
  ...
  "sessionAuth.locked.unlockTitle": "Розблокувати OpenLoop",
  ...
  "desktopHostSwitcher.description": "Перемикання між Local і віддаленими OpenLoop серверами",
  ...
  "multiRun.window.description": "Вікно мультизапуску OpenLoop.",
  ...
  "onboarding.chooser.title": "Ласкаво просимо до OpenLoop",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Якщо OpenLoop не визначає OpenCode автоматично, укажіть шлях до виконуваного файла нижче.",
  "onboarding.localSetup.intro": "OpenCode — серце OpenLoop. Встановіть його, щоб почати.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Зберігає налаштування в OpenLoop і перезавантажує конфігурацію OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Введіть адресу сервера OpenLoop для підключення.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Пропозиції: переконайтеся, що URL вказує на сервер OpenLoop або зверніться до адміністратора сервера.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Цей інстанс працює з іншою версією OpenLoop. Можна підключитися, але оновіть обидва застосунки, якщо щось не працюватиме.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "Сервер працює з OpenLoop, але несумісний із цією версією застосунку. Оновіть OpenLoop на сервері та повторіть спробу.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "Сервер відповів, але не працює OpenLoop. Перевірте, чи адреса вказує на сервер OpenLoop.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "На сервері \"{host}\" не запущено OpenLoop. Перевірте, чи адреса вказує на сервер OpenLoop.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Потрібне оновлення сервера",
  "onboarding.desktopRecovery.remoteIncompatible.description": "Сервер OpenLoop на \"{host}\" несумісний із цією версією застосунку. Оновіть OpenLoop на сервері та повторіть спробу.",
  ...
  "startup.initRecovery.description": "OpenLoop не зміг завершити ініціалізацію. Перевірте, що сервер запущений, і повторіть спробу.",
  ...
  "updateDialog.header.updating": "Оновлення OpenLoop...",
  ...
  "mobileUpdate.toast.available.title": "Доступне оновлення OpenLoop",
  ...
  "opencodeUpdate.toast.upgrading.description": "Залиште OpenLoop відкритим.",
  ...
  "openChamberLogo.aria.logo": "Логотип OpenLoop",
  ...
  "chat.messageBody.richResult.showAgentNotes": "Показати нотатки агента",
  "interactiveUI.artifact.exitExpanded": "Повернутися до розмови",
  "interactiveUI.artifact.experimental": "Експериментально",
  "interactiveUI.artifact.followUpPrepared": "Наступне запитання додано до поля введення для перевірки.",
  "interactiveUI.artifact.fullscreen": "Відкрити на весь екран",
  "interactiveUI.artifact.interactive": "Інтерактивний Artifact",
  "interactiveUI.artifact.originalToolOutput": "Початковий вивід Tool",
  "interactiveUI.artifact.poppedOut": "Цей Artifact відкрито в окремому вікні. Закрийте його, щоб відновити Artifact тут.",
  "interactiveUI.artifact.retry": "Повторити",
  "interactiveUI.artifact.state.blocked.description": "Згенерована сторінка запросила розмітку, навігацію або виконання поза межами безпекового контракту Artifact.",
  "interactiveUI.artifact.state.blocked.title": "Artifact заблоковано з міркувань безпеки",
  "interactiveUI.artifact.state.corrupt.description": "Збережений документ відсутній або пошкоджений. Повторіть спробу, щоб відновити його з початкового результату розмови.",
  "interactiveUI.artifact.state.corrupt.title": "Кеш Artifact потрібно перебудувати",
  "interactiveUI.artifact.state.crashed.description": "Сторінка повідомила про помилку виконання й була вилучена з перегляду. Вона не отримувала дозволів хоста або бізнес-системи.",
  "interactiveUI.artifact.state.crashed.title": "Artifact зупинено після помилки",
  "interactiveUI.artifact.state.error.description": "OpenLoop не зміг підготувати цю сторінку. Оригінальний результат Tool залишається доступним.",
  "interactiveUI.artifact.state.error.title": "Не вдалося завантажити Artifact",
  "interactiveUI.artifact.state.scripts-disabled.description": "Це середовище дозволяє лише статичні Artifact. Оригінальний результат Tool залишається доступним.",
  "interactiveUI.artifact.state.scripts-disabled.title": "Інтерактивні Artifact вимкнено",
  "interactiveUI.artifact.state.stopped.description": "Ви зупинили виконання. Перезапустіть, щоб створити новий ізольований фрейм.",
  "interactiveUI.artifact.state.stopped.title": "Artifact зупинено",
  "interactiveUI.artifact.state.timed-out.description": "OpenLoop зупинив фрейм, оскільки сигнал активності припинився або минув максимальний час виконання. Перезапустіть, щоб повторити спробу.",
  "interactiveUI.artifact.state.timed-out.title": "Термін виконання Artifact минув",
  "interactiveUI.artifact.state.unsupported.description": "Це середовище OpenLoop не підтримує HTML Artifact. Оригінальний результат Tool залишається доступним.",
  "interactiveUI.artifact.state.unsupported.title": "Artifact недоступний у цьому середовищі",
  "interactiveUI.artifact.static": "Статичний Artifact",
  "interactiveUI.artifact.stop": "Зупинити Artifact",
  "interactiveUI.artifact.workspace": "Відкрити в робочій області",
  "interactiveUI.code.copied": "Код скопійовано",
  "interactiveUI.code.copy": "Копіювати код",
  "interactiveUI.common.horizontalScrollHint": "Прокрутіть горизонтально, щоб побачити більше",
  "interactiveUI.common.nextPage": "Наступна сторінка",
  "interactiveUI.common.noData": "Немає даних.",
  "interactiveUI.common.previousPage": "Попередня сторінка",
  "interactiveUI.common.search": "Пошук",
  "interactiveUI.host.live": "Дані в реальному часі",
  "interactiveUI.host.snapshot": "Знімок",
  'interactiveUI.state.error.description': 'Не вдалося завантажити подання. Початковий результат інструмента залишається доступним.',
  'interactiveUI.state.error.title': 'Interactive UI недоступний',
  'interactiveUI.state.forbidden.description': 'Підключений ключ не дозволяє виконати цю операцію.',
  'interactiveUI.state.forbidden.title': 'Доступ заборонено',
  'interactiveUI.state.retry': 'Повторити',
  'interactiveUI.state.stale.description': 'Останнє оновлення завершилося помилкою. Подання зберігає останній успішний результат.',
  'interactiveUI.state.stale.title': 'Показано збережені дані',
  'interactiveUI.state.unauthorized.description': 'Замініть або поновіть ключ доступу та повторіть спробу.',
  'interactiveUI.state.unauthorized.title': 'Термін дії з’єднання минув',
  'interactiveUI.state.unconfigured.description': 'Налаштуйте бізнес-з’єднання цього розширення та повторіть спробу.',
  'interactiveUI.state.unconfigured.title': 'Потрібно налаштувати з’єднання',
  'interactiveUI.state.unreachable.description': 'OpenLoop не вдалося зв’язатися з налаштованим сервісом. Збережені дані не зміняться.',
  'interactiveUI.state.unreachable.title': 'Бізнес-система недоступна',
  "shell.navigation.applications": "Застосунки",
  "shell.resources.add": "Додати ресурс",
  "shell.resources.addAria": "Відкрити меню ресурсів",
  "workbench.board.emptyDescription": "Виберіть доступну поверхню з каталогу або закріпіть її з розмови.",
  "workbench.board.emptyTitle": "Створіть дошку проєкту",
  "workbench.board.subtitle": "{count} плиток на дошці цього проєкту",
  "workbench.board.title": "Робоча панель розширень",
  "workbench.catalog.aria": "Каталог розширень",
  "workbench.catalog.collapse": "Згорнути каталог розширень",
  "workbench.catalog.empty": "Жодне встановлене розширення не надає поверхню робочої панелі.",
  "workbench.catalog.expand": "Розгорнути каталог розширень",
  "workbench.catalog.lifecycleBlocked": "Заблоковано: цей застосунок має очікуване обов’язкове оновлення або недійсну довіру. Вирішіть це перед запуском поверхонь.",
  "workbench.catalog.lifecycleBlockedReason": "Заблоковано через обов’язкове оновлення або проблему з довірою",
  "workbench.catalog.lifecycleUnreachable": "Цей застосунок зараз недоступний. Кешований підписаний вміст може все ще відображатися.",
  "workbench.catalog.requiresContext": "Потрібні параметри контексту",
  "workbench.catalog.title": "Розширення",
  "workbench.loading": "Завантаження робочої панелі розширень…",
  "workbench.noProject": "Відкрийте проєкт, щоб користуватися робочою панеллю розширень.",
  "workbench.pin.added": "Закріплено в робочій панелі розширень",
  "workbench.pin.aria": "Закріпити в робочій панелі розширень",
  "workbench.pin.failed": "Не вдалося закріпити поверхню",
  "workbench.pin.focused": "Наявну плитку робочої панелі розгорнуто",
  "workbench.pin.installedSurfaceMissing": "Поверхня встановленого розширення більше недоступна.",
  "workbench.pin.label": "Закріпити",
  "workbench.pin.noProject": "Відкрийте проєкт, перш ніж закріплювати цю поверхню.",
  "workbench.refresh": "Оновити",
  "workbench.tile.exitFocus": "Вийти з фокусу",
  "workbench.tile.focus": "Розгорнути плитку",
  "workbench.tile.generated": "Поверхня, створена Agent",
  "workbench.tile.generatedSnapshotUnavailable": "Цей створений знімок більше недоступний. Закріпіть його повторно з розмови.",
  "workbench.tile.more": "Інші дії з плиткою",
  "workbench.tile.popout": "Відкрити плитку в окремому вікні",
  "workbench.tile.popoutUnavailable": "У поточному середовищі цю поверхню не можна перемістити в системне вікно.",
  "workbench.tile.poppedOut": "Цю плитку відкрито в окремому вікні. Закрийте його, щоб відновити плитку тут.",
  "workbench.tile.remove": "Видалити з дошки",
  "workbench.tile.resize": "Змінити розмір плитки",
  "workbench.tile.restorePopout": "Повернути плитку на дошку",
  "workbench.tile.surfaceUnavailable": "Цю поверхню розширення вимкнено, втрачено або вона більше не сумісна.",
