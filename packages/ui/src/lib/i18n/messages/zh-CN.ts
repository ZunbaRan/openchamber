...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安装 OpenLoop 以便更快访问',
  'pwa.installPrompt.action': '安装',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已开始安装',
  'pwa.installPrompt.installed': 'OpenLoop 已安装',
  ...
  'mobile.connect.welcome.title': '连接到 OpenLoop',
  ...
  'mobile.connect.password.placeholder': 'OpenLoop 密码',
  ...
  'mobile.connect.error.unreachable': '无法连接到该 OpenLoop 服务器。',
  ...
  'sessions.sidebar.footer.actions.aboutOpenLoop': '关于 OpenLoop',
  ...
  'walkthrough.blocked.serverUnsupported.description': '此应用连接的 OpenLoop 服务器没有响应 walkthrough API，说明它比应用更旧。请将服务器升级到 1.18 或更高版本后刷新。',
  ...
  'contextPanel.browser.trustNotice': '在此打开的页面以对 OpenLoop 的完全访问权限运行 — 检查和截图需要此权限。仅打开你信任的站点：恶意页面可能读取你的数据或以你的身份执行操作。',
  ...
  'filesView.editor.binaryFileDescription': '此文件为二进制文件，无法在 OpenLoop 中编辑。请下载后使用其他应用打开。',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'OpenLoop 需要访问此文件夹。',
  ...
  'aboutDialog.diagnosticsDescription': '包含 OpenLoop 状态、OpenCode 健康信息、目录和项目。',
  ...
  'helpDialog.description': '使用这些快捷键可更高效地导航 OpenLoop',
  ...
  'header.actions.openAppMenu': 'OpenLoop 菜单',
  'header.actions.openAppMenuAria': '打开 OpenLoop 菜单',
  ...
  'sessionAuth.error.networkDescription': '无法验证 UI 会话。如果你是从本地网络中的另一台设备打开 OpenLoop，请在桌面端应用中启用 Desktop Network Access，并使用设置中显示的 LAN 地址。',
  ...
  'sessionAuth.locked.unlockTitle': '解锁 OpenLoop',
  ...
  'desktopHostSwitcher.description': '在 Local 与远程 OpenLoop 服务器之间切换',
  ...
  'multiRun.window.description': 'OpenLoop 多运行窗口。',
  ...
  'onboarding.chooser.title': '欢迎使用 OpenLoop',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 OpenLoop 未自动检测到 OpenCode，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'OpenCode 是 OpenLoop 的核心，先安装它即可开始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 OpenLoop 设置并重新加载 OpenCode 配置。',
  ...
  'onboarding.remoteConnection.description': '输入要连接的 OpenLoop 服务器地址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建议：确认 URL 指向 OpenLoop 服务器，或联系服务器管理员。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此实例正在运行不同版本的 OpenLoop。你可以连接；如果功能异常，请更新两端应用。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '服务器正在运行 OpenLoop，但与此应用版本不兼容。请更新服务器上的 OpenLoop 后重试。',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '服务器有响应，但未运行 OpenLoop。请确认地址是否指向 OpenLoop 服务器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '“{host}” 上的服务器未运行 OpenLoop。请确认地址是否指向 OpenLoop 服务器。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新服务器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '“{host}” 上的 OpenLoop 服务器与此应用版本不兼容。请更新服务器上的 OpenLoop 后重试。',
  ...
  'startup.initRecovery.description': 'OpenLoop 未能完成初始化。请检查服务器是否正在运行，然后重试。',
  ...
  'opencodeUpdate.toast.upgrading.description': '请保持 OpenLoop 打开。',
  ...
  'openChamberLogo.aria.logo': 'OpenLoop 标志',
  ...
  'chat.messageBody.richResult.showAgentNotes': '查看 Agent 说明',
  'interactiveUI.artifact.exitExpanded': '返回对话流',
  'interactiveUI.artifact.experimental': '实验性',
  'interactiveUI.artifact.followUpPrepared': '后续问题已填入输入框，请确认后发送。',
  'interactiveUI.artifact.fullscreen': '全屏打开',
  'interactiveUI.artifact.interactive': '交互式 Artifact',
  'interactiveUI.artifact.originalToolOutput': '原始 Tool 输出',
  'interactiveUI.artifact.poppedOut': '此 Artifact 已在独立窗口中打开。关闭该窗口即可在此恢复。',
  'interactiveUI.artifact.retry': '重试',
  'interactiveUI.artifact.state.blocked.description': '生成的页面请求了超出 Artifact 安全合同的标记、跳转或执行能力。',
  'interactiveUI.artifact.state.blocked.title': '已为安全起见阻止 Artifact',
  'interactiveUI.artifact.state.corrupt.description': '已保存的页面缺失或损坏，请重试以根据原始对话结果重建。',
  'interactiveUI.artifact.state.corrupt.title': '需要重建 Artifact 缓存',
  'interactiveUI.artifact.state.crashed.description': '页面报告运行时错误并已从视图移除；它未获得宿主或业务系统权限。',
  'interactiveUI.artifact.state.crashed.title': 'Artifact 出错后已停止',
  'interactiveUI.artifact.state.error.description': 'OpenLoop 无法准备此页面，原始 Tool 输出仍然可用。',
  'interactiveUI.artifact.state.error.title': '无法加载 Artifact',
  'interactiveUI.artifact.state.scripts-disabled.description': '当前运行环境只允许静态 Artifact，原始 Tool 输出仍然可用。',
  'interactiveUI.artifact.state.scripts-disabled.title': '交互式 Artifact 已关闭',
  'interactiveUI.artifact.state.stopped.description': '你已停止本次执行；重新启动会创建一个全新的隔离 Frame。',
  'interactiveUI.artifact.state.stopped.title': 'Artifact 已停止',
  'interactiveUI.artifact.state.timed-out.description': '由于心跳停止或达到最长执行时间，OpenLoop 已终止此 Frame。可重新启动后再试。',
  'interactiveUI.artifact.state.timed-out.title': 'Artifact 执行租约已到期',
  'interactiveUI.artifact.state.unsupported.description': '此 OpenLoop 运行环境不支持 HTML Artifact，原始 Tool 输出仍然可用。',
  'interactiveUI.artifact.state.unsupported.title': '当前运行环境无法使用 Artifact',
  'interactiveUI.artifact.static': '静态 Artifact',
  'interactiveUI.artifact.stop': '停止 Artifact',
  'interactiveUI.artifact.workspace': '在工作区打开',
  'interactiveUI.code.copied': '代码已复制',
  'interactiveUI.code.copy': '复制代码',
  'interactiveUI.common.horizontalScrollHint': '横向滚动查看更多',
  'interactiveUI.common.nextPage': '下一页',
  'interactiveUI.common.noData': '暂无数据。',
  'interactiveUI.common.previousPage': '上一页',
  'interactiveUI.common.search': '搜索',
  'interactiveUI.host.live': '实时数据',
  'interactiveUI.host.snapshot': '快照',
  'interactiveUI.state.error.description': '视图无法加载，原始 Tool 输出仍然保留。',
  'interactiveUI.state.error.title': 'Interactive UI 暂时不可用',
  'interactiveUI.state.forbidden.description': '当前连接使用的 Key 不允许执行此操作。',
  'interactiveUI.state.forbidden.title': '没有访问权限',
  'interactiveUI.state.retry': '重试',
  'interactiveUI.state.stale.description': '最新刷新失败，视图保留上一次成功结果。',
  'interactiveUI.state.stale.title': '正在显示上次保存的数据',
  'interactiveUI.state.unauthorized.description': '请更换或续期 Access Key，然后重试。',
  'interactiveUI.state.unauthorized.title': '连接凭据已失效',
  'interactiveUI.state.unconfigured.description': '请先配置此扩展的业务连接，然后重试。',
  'interactiveUI.state.unconfigured.title': '需要配置连接',
  'interactiveUI.state.unreachable.description': 'OpenLoop 无法连接已配置的服务，已有数据将保持不变。',
  'interactiveUI.state.unreachable.title': '业务系统暂时不可用',
  'shell.navigation.applications': '应用',
  'shell.resources.add': '添加资源',
  'shell.resources.addAria': '打开资源菜单',
  'workbench.board.emptyDescription': '从目录选择可启动页面，或从对话中固定一个页面。',
  'workbench.board.emptyTitle': '搭建你的项目看板',
  'workbench.board.subtitle': '当前项目看板有 {count} 个磁贴',
  'workbench.board.title': '应用看板',
  'workbench.catalog.aria': '应用目录',
  'workbench.catalog.collapse': '折叠扩展目录',
  'workbench.catalog.empty': '已安装的扩展尚未提供工作台页面。',
  'workbench.catalog.expand': '展开扩展目录',
  'workbench.catalog.lifecycleBlocked': '已阻止：此应用有待处理的必需更新或无效的信任状态。解决后才能启动界面。',
  'workbench.catalog.lifecycleBlockedReason': '因必需更新或信任问题被阻止',
  'workbench.catalog.lifecycleUnreachable': '此应用当前不可达。缓存的已签名内容可能仍可渲染。',
  'workbench.catalog.requiresContext': '需要上下文参数',
  'workbench.catalog.title': '应用',
  'workbench.loading': '正在加载应用看板…',
  'workbench.noProject': '请先打开一个项目，再使用应用看板。',
  'workbench.pin.added': '已固定到应用看板',
  'workbench.pin.aria': '固定到应用看板',
  'workbench.pin.failed': '无法固定此页面',
  'workbench.pin.focused': '已聚焦现有的工作台磁贴',
  'workbench.pin.installedSurfaceMissing': '已安装的扩展页面已不可用。',
  'workbench.pin.label': '固定',
  'workbench.pin.noProject': '请先打开项目，再固定此页面。',
  'workbench.refresh': '刷新',
  'workbench.tile.exitFocus': '退出聚焦',
  'workbench.tile.focus': '聚焦磁贴',
  'workbench.tile.generated': 'Agent 生成页面',
  'workbench.tile.generatedSnapshotUnavailable': '这个生成快照已不可用，请从对话中重新固定。',
  'workbench.tile.more': '更多磁贴操作',
  'workbench.tile.popout': '在独立窗口中打开磁贴',
  'workbench.tile.popoutUnavailable': '当前运行环境无法将此页面移到系统窗口。',
  'workbench.tile.poppedOut': '此磁贴已在独立窗口中打开。关闭该窗口即可在此恢复。',
  'workbench.tile.remove': '从看板移除',
  'workbench.tile.resize': '调整磁贴大小',
  'workbench.tile.restorePopout': '将磁贴恢复到看板',
  'workbench.tile.surfaceUnavailable': '此扩展页面已禁用、缺失或不再兼容。',
