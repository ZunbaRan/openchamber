...
export const dict: Record<I18nKey, string> = {
  ...
  'interactiveUI.state.unreachable.description': 'OpenChamber 无法连接已配置的服务，已有数据将保持不变。',
  ...
  'interactiveUI.artifact.unsupportedRuntime': '当前运行环境不支持 HTML Artifact。',
  'interactiveUI.artifact.navigationBlocked': '已阻止 Artifact 页面跳转。',
  'interactiveUI.artifact.state.unsupported.title': '当前运行环境无法使用 Artifact',
  'interactiveUI.artifact.state.unsupported.description': '此 OpenChamber 运行环境不支持 HTML Artifact，原始 Tool 输出仍然可用。',
  ...
  'interactiveUI.artifact.state.timed-out.description': '由于心跳停止或达到最长执行时间，OpenChamber 已终止此 Frame。可重新启动后再试。',
  ...
  'interactiveUI.artifact.state.error.description': 'OpenChamber 无法准备此页面，原始 Tool 输出仍然可用。',
  ...
  'shell.outputs.label': '输出',
  'shell.outputs.empty': '此任务还没有记录到新生成的文件或附件。',
  ...
  'layout.rightSidebar.extensions': '应用看板',
  'shell.rightRail.aria': '右侧边栏',
  'shell.brand.menu': '打开 OpenChamber 菜单',
  'shell.navigation.primaryAria': '主导航',
  'shell.navigation.newTask': '新建任务',
  'shell.navigation.newTaskMenu': '更多新建任务选项',
  'shell.navigation.projects': '项目',
  'shell.navigation.git': 'Git',
  'shell.navigation.scheduled': '已安排',
  'shell.navigation.applications': '应用',
  'shell.navigation.plugins': '插件',
  'shell.navigation.tasks': '任务',
  'shell.navigation.tasksMenu': '任务列表选项',
  'shell.navigation.advanced': '高级',
  'shell.navigation.compareModels': '多模型对比',
  'shell.resources.add': '添加资源',
  'shell.resources.addAria': '打开资源菜单',
  'shell.resources.sideTask': '侧边任务',
  'shell.resources.browser': '浏览器',
  ...
  'workbench.tile.descriptionFallback': '此页面已可在扩展工作台中加载。',
