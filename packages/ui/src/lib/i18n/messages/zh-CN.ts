...
export const dict: Record<I18nKey, string> = {
  ...
  'layout.rightSidebar.extensions': '扩展',
  'workbench.catalog.aria': '扩展目录',
  'workbench.catalog.title': '扩展',
  ...
  'workbench.noProject': '请先打开一个项目，再使用扩展工作台。',
  'workbench.board.title': '扩展工作台',
