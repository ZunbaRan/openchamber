...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instale o OpenLoop para acessar mais rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Dispensar",
  "pwa.installPrompt.started": "Instalação iniciada",
  "pwa.installPrompt.installed": "OpenLoop instalado",
  ...
  "mobile.connect.welcome.title": "Conectar ao OpenLoop",
  ...
  "mobile.connect.password.placeholder": "Senha do OpenLoop",
  ...
  "mobile.connect.scan.invalid": "Esse código QR não é um código de conexão do OpenLoop.",
  ...
  "mobile.connect.error.unreachable": "Não foi possível acessar esse servidor OpenLoop.",
  ...
  "sessions.sidebar.footer.actions.aboutOpenLoop": "Sobre o OpenLoop",
  ...
  "walkthrough.blocked.serverUnsupported.description": "O servidor OpenLoop ao qual este app está conectado não respondeu à API de walkthrough, ou seja, é mais antigo que o app. Atualize o servidor para 1.18 ou mais recente e atualize a visualização.",
  ...
  "contextPanel.browser.trustNotice": "As páginas abertas aqui são executadas com acesso total ao OpenLoop — necessário para inspeção e capturas de tela. Abra apenas sites confiáveis: uma página maliciosa pode ler seus dados ou agir em seu nome.",
  ...
  "filesView.editor.binaryFileDescription": "Este arquivo é binário e não pode ser editado no OpenLoop. Baixe-o para abrir em outro aplicativo.",
  ...
  "directoryExplorerDialog.browse.permissionDenied": "OpenLoop precisa acessar esta pasta.",
  ...
  "aboutDialog.openChamberVersionLabel": "Versão do OpenLoop {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Inclui o estado do OpenLoop, a integridade do OpenCode, diretórios e projetos.",
  ...
  "helpDialog.description": "Use estes atalhos de teclado para navegar pelo OpenLoop com eficiência",
  ...
  "header.actions.openAppMenu": "Menu do OpenLoop",
  "header.actions.openAppMenuAria": "Abrir menu do OpenLoop",
  ...
  "sessionAuth.error.networkDescription": "Não foi possível verificar a sessão da interface. Se você estiver abrindo o OpenLoop de outro dispositivo na sua rede local, ative o Desktop Network Access no app para desktop e use o endereço LAN mostrado em Configurações.",
  ...
  "desktopHostSwitcher.description": "Alterne entre Local e o servidor remoto do OpenLoop",
  ...
  "multiRun.window.description": "Janela do OpenLoop Multi-Run.",
  ...
  "onboarding.chooser.title": "Boas-vindas ao OpenLoop",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o OpenLoop não detectar o OpenCode automaticamente, defina o caminho do executável a seguir.",
  "onboarding.localSetup.intro": "OpenCode é o coração do OpenLoop. Instale-o para começar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salve nas configurações do OpenLoop e recarregue configurações do OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Digite o endereço de um servidor do OpenLoop para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugestões: verifique se a URL aponta para um servidor OpenLoop ou entre em contato com o administrador do servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instância está executando uma versão diferente do OpenLoop. Você pode se conectar, mas atualize os dois apps se algo não funcionar.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "O servidor está executando OpenLoop, mas não é compatível com esta versão do app. Atualize o OpenLoop no servidor e tente novamente.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "O servidor respondeu, mas não está executando OpenLoop. Verifique se o endereço aponta para um servidor OpenLoop.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "O servidor em \"{host}\" não está executando OpenLoop. Verifique se o endereço aponta para um servidor OpenLoop.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Atualização do servidor necessária",
  "onboarding.desktopRecovery.remoteIncompatible.description": "O servidor OpenLoop em \"{host}\" não é compatível com esta versão do app. Atualize o OpenLoop no servidor e tente novamente.",
  ...
  "startup.initRecovery.description": "O OpenLoop não conseguiu concluir a inicialização. Verifique se o servidor está em execução e tente novamente.",
  ...
  "updateDialog.header.updating": "Atualizando OpenLoop...",
  ...
  "mobileUpdate.toast.available.title": "Atualização do OpenLoop disponível",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantenha o OpenLoop aberto.",
  ...
  "openChamberLogo.aria.logo": "Logo do OpenLoop",
  ...
  "chat.messageBody.richResult.showAgentNotes": "Mostrar notas do agente",
  "interactiveUI.artifact.exitExpanded": "Voltar à conversa",
  "interactiveUI.artifact.experimental": "Experimental",
  "interactiveUI.artifact.followUpPrepared": "A pergunta de acompanhamento foi adicionada ao campo para revisão.",
  "interactiveUI.artifact.fullscreen": "Abrir em tela cheia",
  "interactiveUI.artifact.interactive": "Artifact interativo",
  "interactiveUI.artifact.originalToolOutput": "Saída original da Tool",
  "interactiveUI.artifact.poppedOut": "Este Artifact está aberto em uma janela separada. Feche-a para restaurá-lo aqui.",
  "interactiveUI.artifact.retry": "Tentar novamente",
  "interactiveUI.artifact.state.blocked.description": "A página gerada solicitou marcação, navegação ou recursos de execução fora do contrato de segurança do Artifact.",
  "interactiveUI.artifact.state.blocked.title": "Artifact bloqueado por segurança",
  "interactiveUI.artifact.state.corrupt.description": "O documento salvo está ausente ou danificado. Tente novamente para reconstruí-lo a partir do resultado original da conversa.",
  "interactiveUI.artifact.state.corrupt.title": "O cache do Artifact precisa ser reconstruído",
  "interactiveUI.artifact.state.crashed.description": "A página relatou uma falha de execução e foi removida da visualização. Ela não recebeu permissões do host nem do sistema empresarial.",
  "interactiveUI.artifact.state.crashed.title": "Artifact interrompido após um erro",
  "interactiveUI.artifact.state.error.description": "O OpenLoop não conseguiu preparar esta página. A saída original da Tool continua disponível.",
  "interactiveUI.artifact.state.error.title": "Não foi possível carregar o Artifact",
  "interactiveUI.artifact.state.scripts-disabled.description": "Este ambiente permite apenas Artifacts estáticos. A saída original da Tool continua disponível.",
  "interactiveUI.artifact.state.scripts-disabled.title": "Artifacts interativos estão desativados",
  "interactiveUI.artifact.state.stopped.description": "A execução foi interrompida por você. Reinicie para criar um novo quadro isolado.",
  "interactiveUI.artifact.state.stopped.title": "Artifact interrompido",
  "interactiveUI.artifact.state.timed-out.description": "O OpenLoop interrompeu o quadro porque o sinal de atividade parou ou o tempo máximo de execução terminou. Reinicie para tentar novamente.",
  "interactiveUI.artifact.state.timed-out.title": "A concessão de execução do Artifact expirou",
  "interactiveUI.artifact.state.unsupported.description": "Este ambiente do OpenLoop não oferece suporte a Artifacts HTML. A saída original da Tool continua disponível.",
  "interactiveUI.artifact.state.unsupported.title": "Artifact indisponível neste ambiente",
  "interactiveUI.artifact.static": "Artifact estático",
  "interactiveUI.artifact.stop": "Parar Artifact",
  "interactiveUI.artifact.workspace": "Abrir no espaço de trabalho",
  "interactiveUI.code.copied": "Código copiado",
  "interactiveUI.code.copy": "Copiar código",
  "interactiveUI.common.horizontalScrollHint": "Role horizontalmente para ver mais",
  "interactiveUI.common.nextPage": "Próxima página",
  "interactiveUI.common.noData": "Nenhum dado.",
  "interactiveUI.common.previousPage": "Página anterior",
  "interactiveUI.common.search": "Pesquisar",
  "interactiveUI.host.live": "Dados ao vivo",
  "interactiveUI.host.snapshot": "Instantâneo",
  'interactiveUI.state.error.description': 'Não foi possível carregar a visualização. A saída original da ferramenta continua disponível.',
  'interactiveUI.state.error.title': 'Interactive UI indisponível',
  'interactiveUI.state.forbidden.description': 'A chave conectada não permite esta operação.',
  'interactiveUI.state.forbidden.title': 'Acesso negado',
  'interactiveUI.state.retry': 'Tentar novamente',
  'interactiveUI.state.stale.description': 'A atualização mais recente falhou. A visualização mantém o último resultado bem-sucedido.',
  'interactiveUI.state.stale.title': 'Exibindo dados salvos',
  'interactiveUI.state.unauthorized.description': 'Substitua ou renove a chave de acesso e tente novamente.',
  'interactiveUI.state.unauthorized.title': 'A conexão expirou',
  'interactiveUI.state.unconfigured.description': 'Configure a conexão empresarial desta extensão e tente novamente.',
  'interactiveUI.state.unconfigured.title': 'É preciso configurar a conexão',
  'interactiveUI.state.unreachable.description': 'O OpenLoop não conseguiu acessar o serviço configurado. Os dados salvos permanecerão inalterados.',
  'interactiveUI.state.unreachable.title': 'Sistema empresarial indisponível',
  "shell.navigation.applications": "Aplicativos",
  "shell.resources.add": "Adicionar recurso",
  "shell.resources.addAria": "Abrir menu de recursos",
  "workbench.board.emptyDescription": "Escolha uma superfície disponível no catálogo ou fixe uma da conversa.",
  "workbench.board.emptyTitle": "Monte seu painel de projeto",
  "workbench.board.subtitle": "{count} blocos neste painel de projeto",
  "workbench.board.title": "Espaço de trabalho de extensões",
  "workbench.catalog.aria": "Catálogo de extensões",
  "workbench.catalog.collapse": "Recolher o catálogo de extensões",
  "workbench.catalog.empty": "Nenhuma extensão instalada oferece uma superfície de trabalho.",
  "workbench.catalog.expand": "Expandir o catálogo de extensões",
  "workbench.catalog.lifecycleBlocked": "Bloqueado: este app tem uma atualização obrigatória pendente ou confiança inválida. Resolva antes de iniciar superfícies.",
  "workbench.catalog.lifecycleBlockedReason": "Bloqueado por atualização obrigatória ou problema de confiança",
  "workbench.catalog.lifecycleUnreachable": "Este app está inacessível no momento. O conteúdo assinado em cache ainda pode ser exibido.",
  "workbench.catalog.requiresContext": "Requer parâmetros de contexto",
  "workbench.catalog.title": "Extensões",
  "workbench.loading": "Carregando o espaço de trabalho de extensões…",
  "workbench.noProject": "Abra um projeto para usar o espaço de trabalho de extensões.",
  "workbench.pin.added": "Fixado no espaço de trabalho de extensões",
  "workbench.pin.aria": "Fixar no espaço de trabalho de extensões",
  "workbench.pin.failed": "Não foi possível fixar a superfície",
  "workbench.pin.focused": "O bloco existente foi focalizado",
  "workbench.pin.installedSurfaceMissing": "A superfície da extensão instalada não está mais disponível.",
  "workbench.pin.label": "Fixar",
  "workbench.pin.noProject": "Abra um projeto antes de fixar esta superfície.",
  "workbench.refresh": "Atualizar",
  "workbench.tile.exitFocus": "Sair do foco",
  "workbench.tile.focus": "Focar bloco",
  "workbench.tile.generated": "Superfície gerada pelo Agent",
  "workbench.tile.generatedSnapshotUnavailable": "Este snapshot gerado não está mais disponível. Fixe-o novamente pela conversa.",
  "workbench.tile.more": "Mais ações do bloco",
  "workbench.tile.popout": "Abrir bloco em uma janela separada",
  "workbench.tile.popoutUnavailable": "Esta superfície não pode ser movida para uma janela do sistema no ambiente atual.",
  "workbench.tile.poppedOut": "Este bloco está aberto em uma janela separada. Feche-a para restaurá-lo aqui.",
  "workbench.tile.remove": "Remover do painel",
  "workbench.tile.resize": "Redimensionar bloco",
  "workbench.tile.restorePopout": "Restaurar bloco no painel",
  "workbench.tile.surfaceUnavailable": "Esta superfície de extensão está desativada, ausente ou não é mais compatível.",
