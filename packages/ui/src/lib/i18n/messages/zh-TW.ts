...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安裝 OpenLoop 以便更快存取',
  'pwa.installPrompt.action': '安裝',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已開始安裝',
  'pwa.installPrompt.installed': 'OpenLoop 已安裝',
  ...
  'mobile.connect.welcome.title': '連線至 OpenLoop',
  ...
  'mobile.connect.password.placeholder': 'OpenLoop 密碼',
  ...
  'mobile.connect.scan.invalid': '此 QR code 不是 OpenLoop 連線代碼。',
  ...
  'mobile.connect.relay.badge': '透過 OpenLoop Relay 連線',
  ...
  'mobile.connect.error.unreachable': '無法連線至該 OpenLoop 伺服器。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此實例正在執行不同版本的 OpenLoop。你可以連線；如果功能異常，請更新兩端應用程式。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '伺服器正在執行 OpenLoop，但與此應用程式版本不相容。請更新伺服器上的 OpenLoop 後重試。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新伺服器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」上的 OpenLoop 伺服器與此應用程式版本不相容。請更新伺服器上的 OpenLoop 後重試。',
  ...
  'sessions.sidebar.footer.actions.aboutOpenLoop': '關於 OpenLoop',
  ...
  'walkthrough.blocked.serverUnsupported.description': '此應用程式連線的 OpenLoop 伺服器沒有回應 walkthrough API，代表它比應用程式更舊。請將伺服器升級到 1.18 或更新版本後重新整理。',
  ...
  'contextPanel.browser.trustNotice': '在此開啟的頁面以對 OpenLoop 的完整存取權限執行 — 檢查與截圖需要此權限。僅開啟你信任的網站：惡意頁面可能讀取你的資料或以你的身分執行操作。',
  ...
  'filesView.editor.binaryFileDescription': '此檔案為二進位檔案，無法在 OpenLoop 中編輯。請下載後使用其他應用程式開啟。',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'OpenLoop 需要存取此資料夾。',
  ...
  'aboutDialog.openChamberVersionLabel': 'OpenLoop 版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 OpenLoop 狀態、OpenCode 健康資訊、目錄和專案。',
  ...
  'helpDialog.description': '使用這些快速鍵可更有效率地導覽 OpenLoop',
  ...
  'header.actions.openAppMenu': 'OpenLoop 選單',
  'header.actions.openAppMenuAria': '開啟 OpenLoop 選單',
  ...
  'sessionAuth.error.networkDescription': '無法驗證 UI 會話。如果你是從本機網路中的其他裝置開啟 OpenLoop，請在桌面應用程式中啟用 Desktop Network Access，並使用設定中顯示的 LAN 位址。',
  ...
  'sessionAuth.locked.unlockTitle': '解鎖 OpenLoop',
  ...
  'desktopHostSwitcher.description': '在 Local 與遠端 OpenLoop 伺服器之間切換',
  ...
  'multiRun.window.description': 'OpenLoop 多執行視窗。',
  ...
  'onboarding.chooser.title': '歡迎使用 OpenLoop',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 OpenLoop 未自動偵測到 OpenCode，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'OpenCode 是 OpenLoop 的核心，先安裝它即可開始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 OpenLoop 設定並重新載入 OpenCode 設定。',
  ...
  'onboarding.remoteConnection.description': '輸入要連接的 OpenLoop 伺服器位址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建議：確認 URL 指向 OpenLoop 伺服器，或聯絡伺服器管理員。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '伺服器有回應，但未執行 OpenLoop。請確認位址是否指向 OpenLoop 伺服器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」上的伺服器未執行 OpenLoop。請確認位址是否指向 OpenLoop 伺服器。',
  ...
  'startup.initRecovery.description': 'OpenLoop 未能完成初始化。請檢查伺服器是否正在執行，然後重試。',
  ...
  'updateDialog.header.updating': '正在更新 OpenLoop...',
  ...
  'mobileUpdate.toast.available.title': 'OpenLoop 更新可用',
  ...
  'opencodeUpdate.toast.upgrading.description': '請保持 OpenLoop 開啟。',
  ...
  'openChamberLogo.aria.logo': 'OpenLoop 標誌',
  ...
  'chat.messageBody.richResult.showAgentNotes': '查看 Agent 說明',
  'interactiveUI.artifact.exitExpanded': '返回對話',
  'interactiveUI.artifact.experimental': '實驗性',
  'interactiveUI.artifact.followUpPrepared': '後續問題已填入輸入框，請確認後傳送。',
  'interactiveUI.artifact.fullscreen': '全螢幕開啟',
  'interactiveUI.artifact.interactive': '互動式 Artifact',
  'interactiveUI.artifact.originalToolOutput': '原始 Tool 輸出',
  'interactiveUI.artifact.poppedOut': '此 Artifact 已在獨立視窗中開啟。關閉該視窗即可在此還原。',
  'interactiveUI.artifact.retry': '重試',
  'interactiveUI.artifact.state.blocked.description': '產生的頁面要求了超出 Artifact 安全合約的標記、導覽或執行能力。',
  'interactiveUI.artifact.state.blocked.title': '已基於安全考量阻止 Artifact',
  'interactiveUI.artifact.state.corrupt.description': '儲存的頁面遺失或損壞，請重試以從原始對話結果重建。',
  'interactiveUI.artifact.state.corrupt.title': '需要重建 Artifact 快取',
  'interactiveUI.artifact.state.crashed.description': '頁面回報執行階段錯誤並已從檢視移除；它未取得宿主或業務系統權限。',
  'interactiveUI.artifact.state.crashed.title': 'Artifact 發生錯誤後已停止',
  'interactiveUI.artifact.state.error.description': 'OpenLoop 無法準備此頁面，原始 Tool 輸出仍然可用。',
  'interactiveUI.artifact.state.error.title': '無法載入 Artifact',
  'interactiveUI.artifact.state.scripts-disabled.description': '目前執行環境只允許靜態 Artifact，原始 Tool 輸出仍然可用。',
  'interactiveUI.artifact.state.scripts-disabled.title': '互動式 Artifact 已停用',
  'interactiveUI.artifact.state.stopped.description': '你已停止本次執行；重新啟動會建立全新的隔離 Frame。',
  'interactiveUI.artifact.state.stopped.title': 'Artifact 已停止',
  'interactiveUI.artifact.state.timed-out.description': '因心跳停止或已達最長執行時間，OpenLoop 已終止此 Frame。可重新啟動後再試。',
  'interactiveUI.artifact.state.timed-out.title': 'Artifact 執行租約已到期',
  'interactiveUI.artifact.state.unsupported.description': '此 OpenLoop 執行環境不支援 HTML Artifact，原始 Tool 輸出仍然可用。',
  'interactiveUI.artifact.state.unsupported.title': '目前執行環境無法使用 Artifact',
  'interactiveUI.artifact.static': '靜態 Artifact',
  'interactiveUI.artifact.stop': '停止 Artifact',
  'interactiveUI.artifact.workspace': '在工作區開啟',
  'interactiveUI.code.copied': '程式碼已複製',
  'interactiveUI.code.copy': '複製程式碼',
  'interactiveUI.common.horizontalScrollHint': '橫向捲動查看更多',
  'interactiveUI.common.nextPage': '下一頁',
  'interactiveUI.common.noData': '暫無資料。',
  'interactiveUI.common.previousPage': '上一頁',
  'interactiveUI.common.search': '搜尋',
  'interactiveUI.host.live': '即時資料',
  'interactiveUI.host.snapshot': '快照',
  'interactiveUI.state.error.description': '檢視無法載入，原始 Tool 輸出仍會保留。',
  'interactiveUI.state.error.title': 'Interactive UI 暫時無法使用',
  'interactiveUI.state.forbidden.description': '目前連線使用的 Key 不允許執行此操作。',
  'interactiveUI.state.forbidden.title': '沒有存取權限',
  'interactiveUI.state.retry': '重試',
  'interactiveUI.state.stale.description': '最新重新整理失敗，檢視會保留上一次成功結果。',
  'interactiveUI.state.stale.title': '正在顯示上次儲存的資料',
  'interactiveUI.state.unauthorized.description': '請更換或續期 Access Key，然後重試。',
  'interactiveUI.state.unauthorized.title': '連線憑證已失效',
  'interactiveUI.state.unconfigured.description': '請先設定此擴充功能的業務連線，然後重試。',
  'interactiveUI.state.unconfigured.title': '需要設定連線',
  'interactiveUI.state.unreachable.description': 'OpenLoop 無法連線至已設定的服務，現有資料將保持不變。',
  'interactiveUI.state.unreachable.title': '業務系統暫時無法使用',
  'shell.navigation.applications': '應用程式',
  'shell.resources.add': '新增資源',
  'shell.resources.addAria': '開啟資源選單',
  'workbench.board.emptyDescription': '從目錄選擇可啟動頁面，或從對話中釘選一個頁面。',
  'workbench.board.emptyTitle': '建立你的專案看板',
  'workbench.board.subtitle': '目前專案看板有 {count} 個磁貼',
  'workbench.board.title': '擴充功能工作台',
  'workbench.catalog.aria': '擴充功能目錄',
  'workbench.catalog.collapse': '收合擴充功能目錄',
  'workbench.catalog.empty': '已安裝的擴充功能尚未提供工作台頁面。',
  'workbench.catalog.expand': '展開擴充功能目錄',
  "workbench.catalog.lifecycleBlocked": "已封鎖：此應用程式有待處理的必要更新或無效信任。請先解決再啟動介面。",
  "workbench.catalog.lifecycleBlockedReason": "因必要更新或信任問題而封鎖",
  "workbench.catalog.lifecycleUnreachable": "此應用程式目前無法連線。快取的已簽署內容可能仍可顯示。",
  'workbench.catalog.requiresContext': '需要上下文參數',
  'workbench.catalog.title': '擴充功能',
  'workbench.loading': '正在載入擴充功能工作台…',
  'workbench.noProject': '請先開啟一個專案，再使用擴充功能工作台。',
  'workbench.pin.added': '已釘選到擴充功能工作台',
  'workbench.pin.aria': '釘選到擴充功能工作台',
  'workbench.pin.failed': '無法釘選此頁面',
  'workbench.pin.focused': '已聚焦現有的工作台磁貼',
  'workbench.pin.installedSurfaceMissing': '已安裝的擴充功能頁面已不可用。',
  'workbench.pin.label': '釘選',
  'workbench.pin.noProject': '請先開啟專案，再釘選此頁面。',
  'workbench.refresh': '重新整理',
  'workbench.tile.exitFocus': '退出聚焦',
  'workbench.tile.focus': '聚焦磁貼',
  'workbench.tile.generated': 'Agent 產生頁面',
  'workbench.tile.generatedSnapshotUnavailable': '這個產生快照已不可用，請從對話中重新釘選。',
  'workbench.tile.more': '更多磁貼操作',
  'workbench.tile.popout': '在獨立視窗中開啟磁貼',
  'workbench.tile.popoutUnavailable': '目前執行環境無法將此頁面移到系統視窗。',
  'workbench.tile.poppedOut': '此磁貼已在獨立視窗中開啟。關閉該視窗即可在此還原。',
  'workbench.tile.remove': '從看板移除',
  'workbench.tile.resize': '調整磁貼大小',
  'workbench.tile.restorePopout': '將磁貼還原到看板',
  'workbench.tile.surfaceUnavailable': '此擴充功能頁面已停用、遺失或不再相容。',
