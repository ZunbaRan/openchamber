...
export const dict: Record<I18nKey, string> = {
  ...
  'interactiveUI.state.unreachable.description': 'OpenChamber 無法連線至已設定的服務，現有資料將保持不變。',
  ...
  'interactiveUI.artifact.unsupportedRuntime': '目前執行環境不支援 HTML Artifact。',
  'interactiveUI.artifact.navigationBlocked': '已阻止 Artifact 頁面跳轉。',
  'interactiveUI.artifact.state.unsupported.title': '目前執行環境無法使用 Artifact',
  'interactiveUI.artifact.state.unsupported.description': '此 OpenChamber 執行環境不支援 HTML Artifact，原始 Tool 輸出仍然可用。',
  ...
  'interactiveUI.artifact.state.timed-out.description': '因心跳停止或已達最長執行時間，OpenChamber 已終止此 Frame。可重新啟動後再試。',
  ...
  'interactiveUI.artifact.state.error.description': 'OpenChamber 無法準備此頁面，原始 Tool 輸出仍然可用。',
  ...
  'shell.outputs.label': '輸出',
  'shell.outputs.empty': '此任務尚未記錄到新產生的檔案或附件。',
  ...
  'layout.rightSidebar.extensions': '應用程式看板',
  'shell.rightRail.aria': '右側邊欄',
  'shell.brand.menu': '開啟 OpenChamber 選單',
  'shell.navigation.primaryAria': '主要導覽',
  'shell.navigation.newTask': '新增任務',
  'shell.navigation.newTaskMenu': '更多新增任務選項',
  'shell.navigation.projects': '專案',
  'shell.navigation.git': 'Git',
  'shell.navigation.scheduled': '已排程',
  'shell.navigation.applications': '應用程式',
  'shell.navigation.plugins': '外掛',
  'shell.navigation.tasks': '任務',
  'shell.navigation.tasksMenu': '任務清單選項',
  'shell.navigation.advanced': '進階',
  'shell.navigation.compareModels': '比較模型',
  'shell.resources.add': '新增資源',
  'shell.resources.addAria': '開啟資源選單',
  'shell.resources.sideTask': '側邊任務',
  'shell.resources.browser': '瀏覽器',
