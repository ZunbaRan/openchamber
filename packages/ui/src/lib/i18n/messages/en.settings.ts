export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Copy the workspace ID from the dashboard URL and the auth cookie from your browser developer tools. OpenLoop never scans browser cookie storage.',
  ...
  'settings.window.description': 'OpenLoop settings window.',
  ...
  'settings.page.appearance.description': 'Customize how OpenLoop looks and feels.',
  ...
  'settings.remoteInstances.direct.title': 'Other OpenLoop servers',
  ...
  'settings.remoteInstances.direct.addDialog.description': 'Add another OpenLoop server by URL. Use this when the server is already running and you have a connection token.',
  ...
  'settings.remoteInstances.direct.import.description': 'Paste a connection link from another OpenLoop server.',
  ...
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Invalid OpenLoop connection link.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Create a secure link or token so OpenLoop Desktop can connect to this server.',
  ...
  'settings.remoteInstances.clientAuth.qrScanHint': 'Scan this with the OpenLoop app on your other device. It is single-use and expires.',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': 'Works at home and away. Away traffic goes through OpenLoop Private Relay — an end-to-end encrypted tunnel. No setup needed.',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': 'Scan this QR code with the OpenLoop app on your other device.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Choose whether OpenLoop should start the server for you, or connect to one that is already running.',
  ...
  'settings.openchamber.about.title': 'About OpenLoop',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. OpenLoop will scan it for folders containing',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': 'Start OpenLoop at login',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': 'Start OpenLoop when you log in',
  ...
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': 'Show OpenLoop in the macOS menu bar',
  'settings.openchamber.desktopNetwork.field.macMenuBar': 'Show OpenLoop in the menu bar',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': 'Requires an app restart. When off, OpenLoop does not create the menu bar item or run its session, approval, and usage updates.',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': 'Minimize and close OpenLoop to the system tray',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': 'Minimize and close to the system tray',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': 'Keeps OpenLoop running in the system tray when the main window is minimized or closed.',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'Keep computer awake while OpenLoop is running',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'Keep computer awake while OpenLoop is running',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'OpenLoop asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  ...
  'settings.remoteInstances.page.description': 'Connect to another machine over SSH and open OpenLoop there.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'OpenLoop on the remote machine',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Choose how OpenLoop should run after SSH connects.',
  'settings.remoteInstances.page.section.mainTunnel': 'Local access',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Choose the local address used to open this remote OpenLoop server.',
  'settings.remoteInstances.page.section.authentication': 'Authentication',
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote OpenLoop UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How OpenLoop should be placed on the remote machine when this app starts it for you.',
  ...
  'settings.remoteInstances.page.phase.installingOpenLoop': 'Installing OpenLoop',
  'settings.remoteInstances.page.phase.updatingOpenLoop': 'Updating OpenLoop',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Stored in OpenCode auth, not by OpenLoop. Use {env:VAR_NAME} to read a key from the environment instead.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to OpenCode and never stored by OpenLoop.',
  ...
  'settings.github.page.flow.title': 'Authorize OpenLoop',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Available as fallback if OpenLoop auth is removed',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from OpenLoop.',
  ...
  'settings.voice.page.tooltip.sttLocal': 'On-device transcription on the OpenLoop server. Models download automatically; no API key needed.',
  'settings.voice.page.tooltip.localTts': 'On-device synthesis on the OpenLoop server (Kokoro, English). The model downloads automatically; no API key needed.',
