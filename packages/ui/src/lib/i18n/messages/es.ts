...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instala OpenLoop para acceder más rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Descartar",
  "pwa.installPrompt.started": "Instalación iniciada",
  "pwa.installPrompt.installed": "OpenLoop se instaló",
  ...
  "mobile.connect.welcome.title": "Conéctate a OpenLoop",
  ...
  "mobile.connect.password.placeholder": "Contraseña de OpenLoop",
  ...
  "mobile.connect.scan.invalid": "Ese código QR no es un código de conexión de OpenLoop.",
  ...
  "mobile.connect.relay.badge": "a través de OpenLoop Relay",
  ...
  "mobile.connect.error.unreachable": "No se pudo conectar con ese servidor de OpenLoop.",
  ...
  "sessions.sidebar.footer.actions.aboutOpenLoop": "Acerca de OpenLoop",
  ...
  "walkthrough.blocked.serverUnsupported.description": "El servidor de OpenLoop al que está conectada esta app no respondió a la API de walkthrough, así que es más antiguo que la app. Actualiza el servidor a 1.18 o posterior y vuelve a intentarlo.",
  ...
  "contextPanel.browser.trustNotice": "Las páginas que abras aquí se ejecutan con acceso completo a OpenLoop: necesario para la inspección y las capturas. Abre solo sitios de confianza: una página maliciosa podría leer tus datos o actuar en tu nombre.",
  ...
  "filesView.editor.binaryFileDescription": "Este archivo es binario y no se puede editar en OpenLoop. Descárgalo para abrirlo con otra aplicación.",
  ...
  "directoryExplorerDialog.browse.permissionDenied": "OpenLoop necesita acceso a esta carpeta.",
  ...
  "aboutDialog.openChamberVersionLabel": "Versión de OpenLoop {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de OpenLoop, el estado de OpenCode, directorios y proyectos.",
  ...
  "helpDialog.description": "Usa estos atajos de teclado para navegar por OpenLoop de manera eficiente",
  ...
  "header.actions.openAppMenu": "Menú de OpenLoop",
  "header.actions.openAppMenuAria": "Abrir menú de OpenLoop",
  ...
  "sessionAuth.error.networkDescription": "No pudimos verificar la sesión de la UI. Si abres OpenLoop desde otro dispositivo en tu red local, activa Desktop Network Access en la app de escritorio y usa la dirección LAN que aparece en Ajustes.",
  ...
  "sessionAuth.locked.unlockTitle": "Desbloquear OpenLoop",
  ...
  "desktopHostSwitcher.description": "Cambia entre Local y el servidor remoto de OpenLoop",
  ...
  "multiRun.window.description": "Ventana de OpenLoop Multi-Run.",
  ...
  "onboarding.chooser.title": "Bienvenido a OpenLoop",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si OpenLoop no detecta OpenCode automáticamente, establece la ruta del ejecutable a continuación.",
  "onboarding.localSetup.intro": "OpenCode es el corazón de OpenLoop. Instálalo para empezar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de OpenLoop y recarga la configuración de OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Introduce la dirección de un servidor de OpenLoop para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugerencias: Verifica que la URL apunte a un servidor OpenLoop o contacta al administrador del servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instancia ejecuta una versión diferente de OpenLoop. Puedes conectarte, pero actualiza ambas apps si algo no funciona.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "El servidor ejecuta OpenLoop pero no es compatible con esta versión de la app. Actualiza OpenLoop en el servidor y vuelve a intentarlo.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "El servidor respondió pero no está ejecutando OpenLoop. Verifica que la dirección apunte a un servidor OpenLoop.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "El servidor en \"{host}\" no está ejecutando OpenLoop. Verifica que la dirección apunte a un servidor OpenLoop.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Actualización del servidor requerida",
  "onboarding.desktopRecovery.remoteIncompatible.description": "El servidor OpenLoop en \"{host}\" no es compatible con esta versión de la app. Actualiza OpenLoop en el servidor y vuelve a intentarlo.",
  ...
  "startup.initRecovery.description": "OpenLoop no pudo completar la inicialización. Comprueba que el servidor esté en ejecución y vuelve a intentarlo.",
  ...
  "updateDialog.header.updating": "Actualizando OpenLoop...",
  ...
  "mobileUpdate.toast.available.title": "Actualización de OpenLoop disponible",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantén OpenLoop abierto.",
  ...
  "openChamberLogo.aria.logo": "Logo de OpenLoop",
  ...
  "chat.messageBody.richResult.showAgentNotes": "Mostrar notas del agente",
  "interactiveUI.artifact.exitExpanded": "Volver a la conversación",
  "interactiveUI.artifact.experimental": "Experimental",
  "interactiveUI.artifact.followUpPrepared": "La pregunta de seguimiento se añadió al cuadro de texto para revisarla.",
  "interactiveUI.artifact.fullscreen": "Abrir a pantalla completa",
  "interactiveUI.artifact.interactive": "Artifact interactivo",
  "interactiveUI.artifact.originalToolOutput": "Salida original de Tool",
  "interactiveUI.artifact.poppedOut": "Este Artifact está abierto en una ventana independiente. Ciérrala para restaurarlo aquí.",
  "interactiveUI.artifact.retry": "Reintentar",
  "interactiveUI.artifact.state.blocked.description": "La página generada solicitó marcado, navegación o capacidades de ejecución fuera del contrato de seguridad del Artifact.",
  "interactiveUI.artifact.state.blocked.title": "Artifact bloqueado por seguridad",
  "interactiveUI.artifact.state.corrupt.description": "El documento guardado falta o está dañado. Reintenta para reconstruirlo desde el resultado original de la conversación.",
  "interactiveUI.artifact.state.corrupt.title": "Es necesario reconstruir la caché del Artifact",
  "interactiveUI.artifact.state.crashed.description": "La página informó de un fallo de ejecución y se retiró de la vista. No recibió permisos del host ni del sistema empresarial.",
  "interactiveUI.artifact.state.crashed.title": "El Artifact se detuvo tras un error",
  "interactiveUI.artifact.state.error.description": "OpenLoop no pudo preparar esta página. La salida original de la Tool sigue disponible.",
  "interactiveUI.artifact.state.error.title": "No se pudo cargar el Artifact",
  "interactiveUI.artifact.state.scripts-disabled.description": "Este entorno solo permite Artifacts estáticos. La salida original de la Tool sigue disponible.",
  "interactiveUI.artifact.state.scripts-disabled.title": "Los Artifacts interactivos están desactivados",
  "interactiveUI.artifact.state.stopped.description": "Has detenido la ejecución. Reinicia para crear un marco aislado nuevo.",
  "interactiveUI.artifact.state.stopped.title": "Artifact detenido",
  "interactiveUI.artifact.state.timed-out.description": "OpenLoop detuvo el marco porque el latido se interrumpió o se alcanzó el tiempo máximo de ejecución. Reinicia para volver a intentarlo.",
  "interactiveUI.artifact.state.timed-out.title": "La concesión de ejecución del Artifact caducó",
  "interactiveUI.artifact.state.unsupported.description": "Este entorno de OpenLoop no admite Artifacts HTML. La salida original de la Tool sigue disponible.",
  "interactiveUI.artifact.state.unsupported.title": "Artifact no disponible en este entorno",
  "interactiveUI.artifact.static": "Artifact estático",
  "interactiveUI.artifact.stop": "Detener Artifact",
  "interactiveUI.artifact.workspace": "Abrir en el espacio de trabajo",
  "interactiveUI.code.copied": "Código copiado",
  "interactiveUI.code.copy": "Copiar código",
  "interactiveUI.common.horizontalScrollHint": "Desplázate horizontalmente para ver más",
  "interactiveUI.common.nextPage": "Página siguiente",
  "interactiveUI.common.noData": "No hay datos.",
  "interactiveUI.common.previousPage": "Página anterior",
  "interactiveUI.common.search": "Buscar",
  "interactiveUI.host.live": "Datos en vivo",
  "interactiveUI.host.snapshot": "Instantánea",
  'interactiveUI.state.error.description': 'No se pudo cargar la vista. La salida original de la herramienta sigue disponible.',
  'interactiveUI.state.error.title': 'Interactive UI no está disponible',
  'interactiveUI.state.forbidden.description': 'La clave conectada no permite realizar esta operación.',
  'interactiveUI.state.forbidden.title': 'Acceso denegado',
  'interactiveUI.state.retry': 'Reintentar',
  'interactiveUI.state.stale.description': 'La última actualización falló. La vista conserva el último resultado correcto.',
  'interactiveUI.state.stale.title': 'Se muestran los datos guardados',
  'interactiveUI.state.unauthorized.description': 'Sustituye o renueva la clave de acceso y vuelve a intentarlo.',
  'interactiveUI.state.unauthorized.title': 'La conexión ha caducado',
  'interactiveUI.state.unconfigured.description': 'Configura la conexión empresarial de esta extensión y vuelve a intentarlo.',
  'interactiveUI.state.unconfigured.title': 'Se debe configurar la conexión',
  'interactiveUI.state.unreachable.description': 'OpenLoop no pudo acceder al servicio configurado. Los datos guardados no cambiarán.',
  'interactiveUI.state.unreachable.title': 'Sistema empresarial no disponible',
  "shell.navigation.applications": "Aplicaciones",
  "shell.resources.add": "Añadir recurso",
  "shell.resources.addAria": "Abrir menú de recursos",
  "workbench.board.emptyDescription": "Elige una superficie disponible del catálogo o fija una desde una conversación.",
  "workbench.board.emptyTitle": "Crea tu tablero de proyecto",
  "workbench.board.subtitle": "{count} mosaicos en este tablero de proyecto",
  "workbench.board.title": "Espacio de trabajo de extensiones",
  "workbench.catalog.aria": "Catálogo de extensiones",
  "workbench.catalog.collapse": "Contraer el catálogo de extensiones",
  "workbench.catalog.empty": "Ninguna extensión instalada ofrece una superficie de trabajo.",
  "workbench.catalog.expand": "Expandir el catálogo de extensiones",
  "workbench.catalog.lifecycleBlocked": "Bloqueada: esta aplicación tiene una actualización obligatoria pendiente o una confianza no válida. Resuélvelo antes de iniciar superficies.",
  "workbench.catalog.lifecycleBlockedReason": "Bloqueada por una actualización obligatoria o un problema de confianza",
  "workbench.catalog.lifecycleUnreachable": "Esta aplicación no está accesible en este momento. El contenido firmado en caché puede seguir mostrándose.",
  "workbench.catalog.requiresContext": "Requiere parámetros de contexto",
  "workbench.catalog.title": "Extensiones",
  "workbench.loading": "Cargando el espacio de trabajo de extensiones…",
  "workbench.noProject": "Abre un proyecto para usar el espacio de trabajo de extensiones.",
  "workbench.pin.added": "Fijado en el espacio de trabajo de extensiones",
  "workbench.pin.aria": "Fijar en el espacio de trabajo de extensiones",
  "workbench.pin.failed": "No se pudo fijar la superficie",
  "workbench.pin.focused": "Se enfocó el mosaico existente",
  "workbench.pin.installedSurfaceMissing": "La superficie de la extensión instalada ya no está disponible.",
  "workbench.pin.label": "Fijar",
  "workbench.pin.noProject": "Abre un proyecto antes de fijar esta superficie.",
  "workbench.refresh": "Actualizar",
  "workbench.tile.exitFocus": "Salir del enfoque",
  "workbench.tile.focus": "Enfocar mosaico",
  "workbench.tile.generated": "Superficie generada por el Agent",
  "workbench.tile.generatedSnapshotUnavailable": "Esta instantánea generada ya no está disponible. Vuelve a fijarla desde la conversación.",
  "workbench.tile.more": "Más acciones del mosaico",
  "workbench.tile.popout": "Abrir mosaico en una ventana independiente",
  "workbench.tile.popoutUnavailable": "Esta superficie no puede moverse a una ventana del sistema en el entorno actual.",
  "workbench.tile.poppedOut": "Este mosaico está abierto en una ventana independiente. Ciérrala para restaurarlo aquí.",
  "workbench.tile.remove": "Quitar del tablero",
  "workbench.tile.resize": "Cambiar tamaño del mosaico",
  "workbench.tile.restorePopout": "Restaurar mosaico al tablero",
  "workbench.tile.surfaceUnavailable": "Esta superficie de extensión está deshabilitada, falta o ya no es compatible.",
