...
export const dict = {
  ...
  'interactiveUI.state.unreachable.description': 'OpenChamber could not reach the configured service. Saved data remains unchanged.',
  ...
  'interactiveUI.artifact.unsupportedRuntime': 'HTML Artifact is not supported in this runtime.',
  'interactiveUI.artifact.navigationBlocked': 'Artifact navigation was blocked.',
  'interactiveUI.artifact.state.unsupported.title': 'Artifact is unavailable in this runtime',
  'interactiveUI.artifact.state.unsupported.description': 'This OpenChamber runtime does not support HTML artifacts. The original tool output remains available.',
  ...
  'interactiveUI.artifact.state.timed-out.description': 'OpenChamber stopped the frame because its heartbeat stalled or its maximum execution time elapsed. Restart to try again.',
  ...
  'interactiveUI.artifact.state.error.description': 'OpenChamber could not prepare this page. The original tool output remains available.',
  ...
  'shell.outputs.label': 'Outputs',
  'shell.outputs.empty': 'No new files or attachments have been recorded for this task yet.',
  ...
  'layout.rightSidebar.extensions': 'App board',
  'shell.rightRail.aria': 'Right sidebar',
  'shell.brand.menu': 'Open OpenChamber menu',
  'shell.navigation.primaryAria': 'Primary navigation',
  'shell.navigation.newTask': 'New task',
  'shell.navigation.newTaskMenu': 'More new task options',
  'shell.navigation.projects': 'Projects',
  'shell.navigation.git': 'Git',
  'shell.navigation.scheduled': 'Scheduled',
  'shell.navigation.applications': 'Applications',
  'shell.navigation.plugins': 'Plugins',
  'shell.navigation.tasks': 'Tasks',
  'shell.navigation.tasksMenu': 'Task list options',
  'shell.navigation.advanced': 'Advanced',
  'shell.navigation.compareModels': 'Compare models',
  'shell.resources.add': 'Add resource',
  'shell.resources.addAria': 'Open resource menu',
  'shell.resources.sideTask': 'Side task',
  'shell.resources.browser': 'Browser',
  ...
  'workbench.tile.descriptionFallback': 'This surface is ready to load in the Extension Workbench.',
  ...
  'workbench.tile.context': 'Context',
