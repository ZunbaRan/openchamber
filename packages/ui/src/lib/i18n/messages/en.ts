...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Install OpenLoop for quicker access',
  'pwa.installPrompt.action': 'Install',
  'pwa.installPrompt.dismiss': 'Dismiss',
  'pwa.installPrompt.started': 'Install started',
  'pwa.installPrompt.installed': 'OpenLoop installed',
  ...
  'mobile.connect.welcome.title': 'Connect to OpenLoop',
  ...
  'mobile.connect.password.placeholder': 'OpenLoop password',
  ...
  'mobile.connect.scan.invalid': 'That QR code is not an OpenLoop connection code.',
  ...
  'mobile.connect.error.unreachable': 'Could not reach that OpenLoop server.',
  ...
  'sessions.sidebar.footer.actions.aboutOpenLoop': 'About OpenLoop',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'The OpenLoop server this app is connected to did not answer the walkthrough API, which means it is older than the app. Update the server to 1.18 or newer, then refresh.',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to OpenLoop — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'filesView.editor.binaryFileDescription': 'This file is binary and cannot be edited in OpenLoop. Download it to open with another app.',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'OpenLoop needs access to this folder.',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes OpenLoop state, OpenCode health, directories, and projects.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate OpenLoop efficiently',
  ...
  'header.actions.openAppMenu': 'OpenLoop menu',
  'header.actions.openAppMenuAria': 'Open OpenLoop menu',
  ...
  'sessionAuth.error.networkDescription': 'We could not verify the UI session. If you\'re opening OpenLoop from another device on your local network, make sure Desktop Network Access is enabled on the desktop app and use the LAN address shown in Settings.',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock OpenLoop',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote OpenLoop servers',
  ...
  'multiRun.window.description': 'OpenLoop Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to OpenLoop',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If OpenLoop does not detect OpenCode automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'OpenCode is the heart of OpenLoop — install it to get started.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to OpenLoop settings and reloads OpenCode configuration.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an OpenLoop server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an OpenLoop server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'This instance is running a different OpenLoop version. You can connect, but update both apps if something does not work.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Server is running OpenLoop but is not compatible with this app version. Update OpenLoop on the server, then try again.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running OpenLoop. Verify the address points to an OpenLoop server.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running OpenLoop. Verify the address points to an OpenLoop server.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Server Update Required',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'The OpenLoop server at "{host}" is not compatible with this app version. Update OpenLoop on the server, then try again.',
  ...
  'startup.initRecovery.description': 'OpenLoop could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating OpenLoop...',
  ...
  'mobileUpdate.toast.available.title': 'OpenLoop update available',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Keep OpenLoop open.',
