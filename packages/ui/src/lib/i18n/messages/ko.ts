...
export const dict: Record<I18nKey, string> = {
  ...
  'interactiveUI.state.unreachable.description': 'OpenChamber가 설정된 서비스에 연결하지 못했습니다. 저장된 데이터는 변경되지 않습니다.',
  ...
  'interactiveUI.artifact.unsupportedRuntime': '이 런타임은 HTML Artifact를 지원하지 않습니다.',
  'interactiveUI.artifact.navigationBlocked': 'Artifact 페이지 이동이 차단되었습니다.',
  'interactiveUI.artifact.state.unsupported.title': '이 환경에서는 Artifact를 사용할 수 없습니다',
  'interactiveUI.artifact.state.unsupported.description': '이 OpenChamber 환경은 HTML Artifact를 지원하지 않습니다. 원래 Tool 출력은 계속 사용할 수 있습니다.',
  ...
  'interactiveUI.artifact.state.timed-out.description': '하트비트가 멈추거나 최대 실행 시간에 도달하여 OpenChamber가 프레임을 중지했습니다. 다시 시작해 보세요.',
  ...
  'interactiveUI.artifact.state.error.description': 'OpenChamber가 이 페이지를 준비하지 못했습니다. 원래 Tool 출력은 계속 사용할 수 있습니다.',
  ...
  'shell.outputs.label': '출력',
  'shell.outputs.empty': '이 작업에는 아직 새 파일이나 첨부 파일이 기록되지 않았습니다.',
  ...
  'layout.rightSidebar.extensions': '앱 보드',
  'shell.rightRail.aria': '오른쪽 사이드바',
  'shell.brand.menu': 'OpenChamber 메뉴 열기',
  'shell.navigation.primaryAria': '기본 탐색',
  'shell.navigation.newTask': '새 작업',
  'shell.navigation.newTaskMenu': '새 작업 추가 옵션',
  'shell.navigation.projects': '프로젝트',
  'shell.navigation.git': 'Git',
  'shell.navigation.scheduled': '예약됨',
  'shell.navigation.applications': '애플리케이션',
  'shell.navigation.plugins': '플러그인',
  'shell.navigation.tasks': '작업',
  'shell.navigation.tasksMenu': '작업 목록 옵션',
  'shell.navigation.advanced': '고급',
  'shell.navigation.compareModels': '모델 비교',
  'shell.resources.add': '리소스 추가',
  'shell.resources.addAria': '리소스 메뉴 열기',
  'shell.resources.sideTask': '사이드 작업',
  'shell.resources.browser': '브라우저',
  ...
  'workbench.tile.descriptionFallback': '이 화면은 확장 워크벤치에서 불러올 수 있습니다.',
