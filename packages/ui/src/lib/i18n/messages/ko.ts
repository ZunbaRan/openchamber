...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '더 빠르게 접근하려면 OpenLoop를 설치하세요',
  'pwa.installPrompt.action': '설치',
  'pwa.installPrompt.dismiss': '닫기',
  'pwa.installPrompt.started': '설치가 시작되었습니다',
  'pwa.installPrompt.installed': 'OpenLoop가 설치되었습니다',
  ...
  'mobile.connect.welcome.title': 'OpenLoop에 연결',
  ...
  'mobile.connect.password.placeholder': 'OpenLoop 비밀번호',
  ...
  'mobile.connect.scan.invalid': '이 QR 코드는 OpenLoop 연결 코드가 아닙니다.',
  ...
  'mobile.connect.relay.badge': 'OpenLoop Relay 경유',
  ...
  'mobile.connect.error.unreachable': '해당 OpenLoop 서버에 연결할 수 없습니다.',
  ...
  'sessions.sidebar.footer.actions.aboutOpenLoop': 'OpenLoop 정보',
  ...
  'walkthrough.blocked.serverUnsupported.description': '이 앱이 연결된 OpenLoop 서버가 워크스루 API에 응답하지 않았습니다. 즉 앱보다 오래된 버전입니다. 서버를 1.18 이상으로 업데이트한 뒤 새로 고치세요.',
  ...
  'contextPanel.browser.trustNotice': '여기서 여는 페이지는 OpenLoop에 대한 전체 액세스 권한으로 실행됩니다 — 검사와 스크린샷에 필요합니다. 신뢰하는 사이트만 여세요: 악성 페이지가 데이터를 읽거나 사용자를 대신해 동작할 수 있습니다.',
  ...
  'filesView.editor.binaryFileDescription': '이 파일은 바이너리이므로 OpenLoop에서 편집할 수 없습니다. 다른 앱으로 열려면 다운로드하세요.',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'OpenLoop에서 이 폴더에 접근해야 합니다.',
  ...
  'aboutDialog.openChamberVersionLabel': 'OpenLoop 버전 {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'OpenLoop 상태, OpenCode 상태, 디렉터리 및 프로젝트를 포함합니다.',
  ...
  'helpDialog.description': '이 단축키로 OpenLoop를 빠르게 탐색하세요',
  ...
  'header.actions.openAppMenu': 'OpenLoop 메뉴',
  'header.actions.openAppMenuAria': 'OpenLoop 메뉴 열기',
  ...
  'sessionAuth.error.networkDescription': 'UI 세션을 확인할 수 없습니다. 로컬 네트워크의 다른 기기에서 OpenLoop를 열고 있다면 데스크톱 앱에서 Desktop Network Access를 활성화하고 설정에 표시되는 LAN 주소를 사용하세요.',
  ...
  'sessionAuth.locked.unlockTitle': 'OpenLoop 잠금 해제',
  ...
  'desktopHostSwitcher.description': '로컬과 원격 OpenLoop 서버 간에 전환합니다',
  ...
  'multiRun.window.description': 'OpenLoop 멀티런 창.',
  ...
  'onboarding.chooser.title': 'OpenLoop에 오신 것을 환영합니다',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'OpenLoop가 OpenCode를 자동으로 찾지 못하면 아래에 바이너리 경로를 설정하세요.',
  'onboarding.localSetup.intro': 'OpenCode는 OpenLoop의 심장입니다. 먼저 설치하고 시작하세요.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'OpenLoop 설정에 저장하고 OpenCode 구성을 다시 로드합니다.',
  ...
  'onboarding.remoteConnection.description': '연결할 OpenLoop 서버 주소를 입력하세요.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'URL이 OpenLoop 서버를 가리키는지 확인하거나 서버 관리자에게 문의하세요.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '이 인스턴스는 다른 OpenLoop 버전을 실행 중입니다. 연결할 수 있지만 문제가 있으면 양쪽 앱을 업데이트하세요.',
  'onboarding.remoteConnection.probe.incompatibleMessage': '서버에서 OpenLoop가 실행 중이지만 이 앱 버전과 호환되지 않습니다. 서버의 OpenLoop를 업데이트한 후 다시 시도하세요.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '서버가 응답했지만 OpenLoop가 실행 중이 아닙니다. 주소가 OpenLoop 서버를 가리키는지 확인하세요.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '"{host}"의 서버에서 OpenLoop가 실행 중이 아닙니다. 주소가 OpenLoop 서버를 가리키는지 확인하세요.',
  'onboarding.desktopRecovery.remoteIncompatible.title': '서버 업데이트 필요',
  'onboarding.desktopRecovery.remoteIncompatible.description': '"{host}"의 OpenLoop 서버가 이 앱 버전과 호환되지 않습니다. 서버의 OpenLoop를 업데이트한 후 다시 시도하세요.',
  ...
  'startup.initRecovery.description': 'OpenLoop 초기화를 완료할 수 없습니다. 서버가 실행 중인지 확인한 뒤 다시 시도하세요.',
  ...
  'updateDialog.header.updating': 'OpenLoop 업데이트 중…',
  ...
  'mobileUpdate.toast.available.title': 'OpenLoop 업데이트 사용 가능',
  ...
  'opencodeUpdate.toast.upgrading.description': 'OpenLoop를 열어 두세요.',
  ...
  'openChamberLogo.aria.logo': 'OpenLoop 로고',
  ...
  'chat.messageBody.richResult.showAgentNotes': '에이전트 메모 보기',
  'interactiveUI.artifact.exitExpanded': '대화로 돌아가기',
  'interactiveUI.artifact.experimental': '실험적',
  'interactiveUI.artifact.followUpPrepared': '후속 질문을 입력창에 추가했습니다. 확인 후 전송하세요.',
  'interactiveUI.artifact.fullscreen': '전체 화면으로 열기',
  'interactiveUI.artifact.interactive': '대화형 Artifact',
  'interactiveUI.artifact.originalToolOutput': '원본 Tool 출력',
  'interactiveUI.artifact.poppedOut': '이 Artifact는 별도 창에서 열려 있습니다. 해당 창을 닫으면 여기로 복원됩니다.',
  'interactiveUI.artifact.retry': '다시 시도',
  'interactiveUI.artifact.state.blocked.description': '생성된 페이지가 Artifact 안전 계약을 벗어난 마크업, 탐색 또는 실행 기능을 요청했습니다.',
  'interactiveUI.artifact.state.blocked.title': '안전을 위해 Artifact를 차단했습니다',
  'interactiveUI.artifact.state.corrupt.description': '저장된 문서가 없거나 손상되었습니다. 원래 대화 결과에서 다시 만들려면 재시도하세요.',
  'interactiveUI.artifact.state.corrupt.title': 'Artifact 캐시를 다시 만들어야 합니다',
  'interactiveUI.artifact.state.crashed.description': '페이지에서 런타임 오류를 보고하여 화면에서 제거했습니다. 호스트나 업무 시스템 권한은 제공되지 않았습니다.',
  'interactiveUI.artifact.state.crashed.title': '오류로 Artifact가 중지되었습니다',
  'interactiveUI.artifact.state.error.description': 'OpenLoop가 이 페이지를 준비하지 못했습니다. 원래 Tool 출력은 계속 사용할 수 있습니다.',
  'interactiveUI.artifact.state.error.title': 'Artifact를 불러올 수 없습니다',
  'interactiveUI.artifact.state.scripts-disabled.description': '이 환경에서는 정적 Artifact만 허용됩니다. 원래 Tool 출력은 계속 사용할 수 있습니다.',
  'interactiveUI.artifact.state.scripts-disabled.title': '대화형 Artifact가 비활성화되었습니다',
  'interactiveUI.artifact.state.stopped.description': '사용자가 실행을 중지했습니다. 다시 시작하면 새로운 격리 프레임이 생성됩니다.',
  'interactiveUI.artifact.state.stopped.title': 'Artifact가 중지되었습니다',
  'interactiveUI.artifact.state.timed-out.description': '하트비트가 멈추거나 최대 실행 시간에 도달하여 OpenLoop가 프레임을 중지했습니다. 다시 시작해 보세요.',
  'interactiveUI.artifact.state.timed-out.title': 'Artifact 실행 임대가 만료되었습니다',
  'interactiveUI.artifact.state.unsupported.description': '이 OpenLoop 환경은 HTML Artifact를 지원하지 않습니다. 원래 Tool 출력은 계속 사용할 수 있습니다.',
  'interactiveUI.artifact.state.unsupported.title': '이 환경에서는 Artifact를 사용할 수 없습니다',
  'interactiveUI.artifact.static': '정적 Artifact',
  'interactiveUI.artifact.stop': 'Artifact 중지',
  'interactiveUI.artifact.workspace': '워크스페이스에서 열기',
  'interactiveUI.code.copied': '코드가 복사됨',
  'interactiveUI.code.copy': '코드 복사',
  'interactiveUI.common.horizontalScrollHint': '더 보려면 가로로 스크롤하세요',
  'interactiveUI.common.nextPage': '다음 페이지',
  'interactiveUI.common.noData': '데이터가 없습니다.',
  'interactiveUI.common.previousPage': '이전 페이지',
  'interactiveUI.common.search': '검색',
  'interactiveUI.host.live': '실시간 데이터',
  'interactiveUI.host.snapshot': '스냅샷',
  'interactiveUI.state.error.description': '뷰를 불러올 수 없습니다. 원래 도구 출력은 계속 사용할 수 있습니다.',
  'interactiveUI.state.error.title': 'Interactive UI를 사용할 수 없습니다',
  'interactiveUI.state.forbidden.description': '연결된 키로는 이 작업을 수행할 수 없습니다.',
  'interactiveUI.state.forbidden.title': '접근이 거부되었습니다',
  'interactiveUI.state.retry': '다시 시도',
  'interactiveUI.state.stale.description': '최근 새로 고침에 실패하여 마지막으로 성공한 결과를 유지합니다.',
  'interactiveUI.state.stale.title': '저장된 데이터를 표시하고 있습니다',
  'interactiveUI.state.unauthorized.description': '액세스 키를 교체하거나 갱신한 후 다시 시도하세요.',
  'interactiveUI.state.unauthorized.title': '연결이 만료되었습니다',
  'interactiveUI.state.unconfigured.description': '이 확장 프로그램의 비즈니스 연결을 설정한 후 다시 시도하세요.',
  'interactiveUI.state.unconfigured.title': '연결 설정이 필요합니다',
  'interactiveUI.state.unreachable.description': 'OpenLoop가 설정된 서비스에 연결하지 못했습니다. 저장된 데이터는 변경되지 않습니다.',
  'interactiveUI.state.unreachable.title': '비즈니스 시스템을 사용할 수 없습니다',
  'shell.navigation.applications': '애플리케이션',
  'shell.resources.add': '리소스 추가',
  'shell.resources.addAria': '리소스 메뉴 열기',
  'workbench.board.emptyDescription': '카탈로그에서 실행 가능한 화면을 선택하거나 대화에서 화면을 고정하세요.',
  'workbench.board.emptyTitle': '프로젝트 보드 만들기',
  'workbench.board.subtitle': '이 프로젝트 보드에 타일 {count}개',
  'workbench.board.title': '확장 워크벤치',
  'workbench.catalog.aria': '확장 카탈로그',
  'workbench.catalog.collapse': '확장 카탈로그 접기',
  'workbench.catalog.empty': '설치된 확장에 워크벤치 화면이 없습니다.',
  'workbench.catalog.expand': '확장 카탈로그 펼치기',
  "workbench.catalog.lifecycleBlocked": "차단됨: 이 앱에 대기 중인 필수 업데이트 또는 잘못된 신뢰 상태가 있습니다. 표면을 시작하기 전에 해결하세요.",
  "workbench.catalog.lifecycleBlockedReason": "필수 업데이트 또는 신뢰 문제로 차단됨",
  "workbench.catalog.lifecycleUnreachable": "이 앱은 현재 연결할 수 없습니다. 캐시된 서명 콘텐츠는 계속 표시될 수 있습니다.",
  'workbench.catalog.requiresContext': '컨텍스트 매개변수가 필요합니다',
  'workbench.catalog.title': '확장',
  'workbench.loading': '확장 워크벤치 불러오는 중…',
  'workbench.noProject': '확장 워크벤치를 사용하려면 프로젝트를 여세요.',
  'workbench.pin.added': '확장 워크벤치에 고정했습니다',
  'workbench.pin.aria': '확장 워크벤치에 고정',
  'workbench.pin.failed': '화면을 고정할 수 없습니다',
  'workbench.pin.focused': '기존 워크벤치 타일에 포커스했습니다',
  'workbench.pin.installedSurfaceMissing': '설치된 확장 화면을 더 이상 사용할 수 없습니다.',
  'workbench.pin.label': '고정',
  'workbench.pin.noProject': '이 화면을 고정하기 전에 프로젝트를 여세요.',
  'workbench.refresh': '새로 고침',
  'workbench.tile.exitFocus': '포커스 종료',
  'workbench.tile.focus': '타일 포커스',
  'workbench.tile.generated': 'Agent 생성 화면',
  'workbench.tile.generatedSnapshotUnavailable': '생성된 스냅샷을 더 이상 사용할 수 없습니다. 대화에서 다시 고정하세요.',
  'workbench.tile.more': '타일 작업 더 보기',
  'workbench.tile.popout': '타일을 별도 창에서 열기',
  'workbench.tile.popoutUnavailable': '현재 런타임에서는 이 화면을 시스템 창으로 이동할 수 없습니다.',
  'workbench.tile.poppedOut': '이 타일은 별도 창에서 열려 있습니다. 해당 창을 닫으면 여기로 복원됩니다.',
  'workbench.tile.remove': '보드에서 제거',
  'workbench.tile.resize': '타일 크기 조절',
  'workbench.tile.restorePopout': '타일을 보드로 복원',
  'workbench.tile.surfaceUnavailable': '이 확장 화면은 비활성화되었거나 없거나 더 이상 호환되지 않습니다.',
