/** Theme bridge + scoped utilities for generative widgets. */
/**
 * CSS variable bridge — maps guideline variable names to OpenChamber
...
--font-mono:                  ui-monospace, monospace, ui-monospace, monospace;
...
/* ── Chart palette (mapped from OpenChamber chart-1~5) ─ */
