...
- Declarative 已新增 `divider`、`timeline`、`activity-feed`、`comparison`、`tabs`、`accordion`、`code-block`、`sparkline`、`git-graph`、`tree`、`diff-summary`。Generated Declarative 使用同一渲染器，但仍经过节点/深度/行列/文本上限和无 action/query/binding/script 的 sanitizer。
