...
| OCIX third-party Remote path implementation or acceptance (R1–R3: connect, lazy resources, TTL cache, health/update, granted/re-consent); not Host API foundation implementation | [OCIX Remote mode detailed plan](docs/OCIX_REMOTE_MODE_DETAILED_PLAN.md) and dual-path vision [OCIX_DUAL_PATH_HOSTED_AND_DEV_SERVER_PLAN.md](docs/OCIX_DUAL_PATH_HOSTED_AND_DEV_SERVER_PLAN.md) |
